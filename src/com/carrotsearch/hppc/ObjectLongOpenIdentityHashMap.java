...
/**
 * An identity hash map of <code>KType</code> to <code>long</code>, implemented using open
 * addressing with linear probing for collision resolution.
 * 
 * <p>
 * This class implements the {@link ObjectLongMap} interface using
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: ObjectLongOpenIdentityHashMap.java") 
public class ObjectLongOpenIdentityHashMap<KType>
    implements ObjectLongMap<KType>, Cloneable
{
    /**
     ...
     */
    public ObjectLongOpenIdentityHashMap()
    {
     ...
     */
    public ObjectLongOpenIdentityHashMap(int initialCapacity)
    {
     ...
     */
    public ObjectLongOpenIdentityHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ObjectLongOpenIdentityHashMap(ObjectLongAssociativeContainer<KType> container)
    {
    ...
    @Override
    public int putAll(
        ObjectLongAssociativeContainer<? extends KType> container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends ObjectLongCursor<? extends KType>> iterable)
    {
        final int count = this.assigned;
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof ObjectLongMap)
            {
                ...
                /*  */
                ObjectLongMap<KType> other = (ObjectLongMap<KType>) obj;
                if (other.size() == this.size())
                {
                    for (ObjectLongCursor<KType> c : other)
                    {
                        if (this.containsKey(c.key))
                        {
                            long v = this.get(c.key);
                                                         if (((c.value) == (v)))
                            {
                                continue;
                            }
    ...
    private final class EntryIterator extends AbstractIterator<ObjectLongCursor<KType>>
    {
        ...
        {
            cursor = new ObjectLongCursor<KType>();
            cursor.index = -1;
        }
    ...
    {
        private final ObjectLongOpenIdentityHashMap<KType> owner = 
            ObjectLongOpenIdentityHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectLongOpenIdentityHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectLongOpenIdentityHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectLongOpenIdentityHashMap.this.allocated;                                                              
            final long [] values = ObjectLongOpenIdentityHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ObjectLongOpenIdentityHashMap<KType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            ObjectLongOpenIdentityHashMap<KType> cloned = 
                (ObjectLongOpenIdentityHashMap<KType>) super.clone();
     ...
     */
    public static <KType> ObjectLongOpenIdentityHashMap<KType> from(KType [] keys, long [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ObjectLongOpenIdentityHashMap<KType> map = new ObjectLongOpenIdentityHashMap<KType>();
     ...
     */
    public static <KType> ObjectLongOpenIdentityHashMap<KType> from(ObjectLongAssociativeContainer<KType> container)
    {
        return new ObjectLongOpenIdentityHashMap<KType>(container);
    }
     ...
     * shortcut). 
     */
    public static <KType> ObjectLongOpenIdentityHashMap<KType> newInstance()
    {
        return new ObjectLongOpenIdentityHashMap<KType>();
    }
     ...
     */
    public static <KType> ObjectLongOpenIdentityHashMap<KType> newInstanceWithoutPerturbations()
    {
        return new ObjectLongOpenIdentityHashMap<KType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <KType> ObjectLongOpenIdentityHashMap<KType> newInstance(int initialCapacity, float loadFactor)
    {
        return new ObjectLongOpenIdentityHashMap<KType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <KType> ObjectLongOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <KType> ObjectLongOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
