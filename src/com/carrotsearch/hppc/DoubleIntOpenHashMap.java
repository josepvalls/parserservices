...
/**
 * A hash map of <code>double</code> to <code>int</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: DoubleIntOpenHashMap.java") 
public class DoubleIntOpenHashMap
    implements DoubleIntMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        DoubleIntAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends DoubleIntCursor> iterable)
    {
        final int count = this.assigned;
        for (DoubleIntCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    private final class EntryIterator extends AbstractIterator<DoubleIntCursor>
    {
        private final DoubleIntCursor cursor;

        public EntryIterator()
        {
            cursor = new DoubleIntCursor();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = DoubleIntOpenHashMap.this.allocated;                                                              
            final int [] values = DoubleIntOpenHashMap.this.values;                                                                      
    ...
    public DoubleIntOpenHashMap clone()
    {
        ...
        {
            /*  */
            DoubleIntOpenHashMap cloned = 
                (DoubleIntOpenHashMap) super.clone();
