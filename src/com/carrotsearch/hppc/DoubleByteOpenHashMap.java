...
/**
 * A hash map of <code>double</code> to <code>byte</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: DoubleByteOpenHashMap.java") 
public class DoubleByteOpenHashMap
    implements DoubleByteMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        DoubleByteAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends DoubleByteCursor> iterable)
    {
        final int count = this.assigned;
        for (DoubleByteCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    private final class EntryIterator extends AbstractIterator<DoubleByteCursor>
    {
        private final DoubleByteCursor cursor;

        public EntryIterator()
        {
            cursor = new DoubleByteCursor();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = DoubleByteOpenHashMap.this.allocated;                                                              
            final byte [] values = DoubleByteOpenHashMap.this.values;                                                                      
    ...
    public DoubleByteOpenHashMap clone()
    {
        ...
        {
            /*  */
            DoubleByteOpenHashMap cloned = 
                (DoubleByteOpenHashMap) super.clone();
