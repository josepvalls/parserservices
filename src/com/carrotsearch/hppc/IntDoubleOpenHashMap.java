...
/**
 * A hash map of <code>int</code> to <code>double</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: IntDoubleOpenHashMap.java") 
    ...
    implements IntDoubleMap, Cloneable
{
    ...
    @Override
    public int putAll(
        IntDoubleAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends IntDoubleCursor> iterable)
    {
        final int count = this.assigned;
    ...
    {
        private final IntDoubleOpenHashMap owner = 
            IntDoubleOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return IntDoubleOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return IntDoubleOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = IntDoubleOpenHashMap.this.allocated;                                                              
            final double [] values = IntDoubleOpenHashMap.this.values;                                                                      
    ...
    public IntDoubleOpenHashMap clone()
    {
        ...
        {
            /*  */
            IntDoubleOpenHashMap cloned = 
                (IntDoubleOpenHashMap) super.clone();
    ...
    {
        return new IntDoubleOpenHashMap(container);
    }
    ...
    {
        return new IntDoubleOpenHashMap();
    }
    ...
    {
        return new IntDoubleOpenHashMap(initialCapacity, loadFactor);
    }
