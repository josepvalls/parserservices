...
/**
 * A hash map of <code>KType</code> to <code>byte</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ObjectByteOpenHashMap.java") 
public class ObjectByteOpenHashMap<KType>
    implements ObjectByteMap<KType>, Cloneable
{
     ...
     */
    public ObjectByteOpenHashMap(int initialCapacity)
    {
     ...
     */
    public ObjectByteOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ObjectByteOpenHashMap(ObjectByteAssociativeContainer<KType> container)
    {
    ...
    {
        private final ObjectByteOpenHashMap<KType> owner = 
            ObjectByteOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectByteOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectByteOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectByteOpenHashMap.this.allocated;                                                              
            final byte [] values = ObjectByteOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ObjectByteOpenHashMap<KType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            ObjectByteOpenHashMap<KType> cloned = 
                (ObjectByteOpenHashMap<KType>) super.clone();
     ...
     */
    public static <KType> ObjectByteOpenHashMap<KType> from(KType [] keys, byte [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ObjectByteOpenHashMap<KType> map = new ObjectByteOpenHashMap<KType>();
     ...
     */
    public static <KType> ObjectByteOpenHashMap<KType> from(ObjectByteAssociativeContainer<KType> container)
    {
        return new ObjectByteOpenHashMap<KType>(container);
    }
     ...
     * shortcut). 
     */
    public static <KType> ObjectByteOpenHashMap<KType> newInstance()
    {
        return new ObjectByteOpenHashMap<KType>();
    }
     ...
     */
    public static <KType> ObjectByteOpenHashMap<KType> newInstanceWithoutPerturbations()
    {
        return new ObjectByteOpenHashMap<KType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <KType> ObjectByteOpenHashMap<KType> newInstance(int initialCapacity, float loadFactor)
    {
        return new ObjectByteOpenHashMap<KType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <KType> ObjectByteOpenHashMap<KType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <KType> ObjectByteOpenHashMap<KType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
