...
/**
 * A hash map of <code>int</code> to <code>short</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: IntShortOpenHashMap.java") 
public class IntShortOpenHashMap
    implements IntShortMap, Cloneable
{
    /**
     ...
     */
    public IntShortOpenHashMap(int initialCapacity)
    {
     ...
     */
    public IntShortOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public IntShortOpenHashMap(IntShortAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        IntShortAssociativeContainer container)
    {
        final int count = this.assigned;
        for (IntShortCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends IntShortCursor> iterable)
    {
        final int count = this.assigned;
        for (IntShortCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    private void expandAndPut(int pendingKey, short pendingValue, int freeSlot)
    {
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return IntShortOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return IntShortOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = IntShortOpenHashMap.this.allocated;                                                              
            final short [] values = IntShortOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public IntShortOpenHashMap clone()
    {
        try
        {
            /*  */
            IntShortOpenHashMap cloned = 
                (IntShortOpenHashMap) super.clone();
     ...
     */
    public static  IntShortOpenHashMap from(int [] keys, short [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        IntShortOpenHashMap map = new IntShortOpenHashMap();
     ...
     */
    public static  IntShortOpenHashMap from(IntShortAssociativeContainer container)
    {
        return new IntShortOpenHashMap(container);
    }
     ...
     */
    public static  IntShortOpenHashMap newInstanceWithoutPerturbations()
    {
        return new IntShortOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  IntShortOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new IntShortOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  IntShortOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  IntShortOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
