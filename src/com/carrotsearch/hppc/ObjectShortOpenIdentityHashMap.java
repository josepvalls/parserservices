...
/**
 * An identity hash map of <code>KType</code> to <code>short</code>, implemented using open
 * addressing with linear probing for collision resolution.
 * 
 * <p>
 * This class implements the {@link ObjectShortMap} interface using
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: ObjectShortOpenIdentityHashMap.java") 
public class ObjectShortOpenIdentityHashMap<KType>
    implements ObjectShortMap<KType>, Cloneable
{
     ...
     */
    public ObjectShortOpenIdentityHashMap()
    {
     ...
     */
    public ObjectShortOpenIdentityHashMap(int initialCapacity)
    {
     ...
     */
    public ObjectShortOpenIdentityHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ObjectShortOpenIdentityHashMap(ObjectShortAssociativeContainer<KType> container)
    {
    ...
    public short put(KType key, short value)
    {
        ...
        while (allocated[slot])
        {
            if (key == keys[slot])
            {
                final short oldValue = values[slot];
                values[slot] = value;
                return oldValue;
            }
    ...
    @Override
    public int putAll(
        ObjectShortAssociativeContainer<? extends KType> container)
    {
        final int count = this.assigned;
        for (ObjectShortCursor<? extends KType> c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends ObjectShortCursor<? extends KType>> iterable)
    {
        final int count = this.assigned;
        for (ObjectShortCursor<? extends KType> c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
         ...
         public short putOrAdd(KType key, short putValue, short additionValue)
    {
        ...
        while (allocated[slot])
        {
            if (key == keys[slot])
            {
                return values[slot] = (short) (values[slot] + additionValue);
            }
    ...
    public short lset(short key)
    {
        ...
        final short previous = values[lastSlot];
        values[lastSlot] = key;
        return previous;
    }
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof ObjectShortMap)
            {
                ...
                /*  */
                ObjectShortMap<KType> other = (ObjectShortMap<KType>) obj;
                if (other.size() == this.size())
                {
                    for (ObjectShortCursor<KType> c : other)
                    {
                        if (this.containsKey(c.key))
                        {
                            short v = this.get(c.key);
                                                         if (((c.value) == (v)))
                            {
                                continue;
                            }
    ...
    private final class EntryIterator extends AbstractIterator<ObjectShortCursor<KType>>
    {
        ...
        {
            cursor = new ObjectShortCursor<KType>();
            cursor.index = -1;
        }
    ...
    {
        private final ObjectShortOpenIdentityHashMap<KType> owner = 
            ObjectShortOpenIdentityHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectShortOpenIdentityHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectShortOpenIdentityHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectShortOpenIdentityHashMap.this.allocated;                                                              
            final short [] values = ObjectShortOpenIdentityHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ObjectShortOpenIdentityHashMap<KType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            ObjectShortOpenIdentityHashMap<KType> cloned = 
                (ObjectShortOpenIdentityHashMap<KType>) super.clone();
     ...
     */
    public static <KType> ObjectShortOpenIdentityHashMap<KType> from(KType [] keys, short [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ObjectShortOpenIdentityHashMap<KType> map = new ObjectShortOpenIdentityHashMap<KType>();
     ...
     */
    public static <KType> ObjectShortOpenIdentityHashMap<KType> from(ObjectShortAssociativeContainer<KType> container)
    {
        return new ObjectShortOpenIdentityHashMap<KType>(container);
    }
     ...
     * shortcut). 
     */
    public static <KType> ObjectShortOpenIdentityHashMap<KType> newInstance()
    {
        return new ObjectShortOpenIdentityHashMap<KType>();
    }
     ...
     */
    public static <KType> ObjectShortOpenIdentityHashMap<KType> newInstanceWithoutPerturbations()
    {
        return new ObjectShortOpenIdentityHashMap<KType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <KType> ObjectShortOpenIdentityHashMap<KType> newInstance(int initialCapacity, float loadFactor)
    {
        return new ObjectShortOpenIdentityHashMap<KType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <KType> ObjectShortOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <KType> ObjectShortOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
