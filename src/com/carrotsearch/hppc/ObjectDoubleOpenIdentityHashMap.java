...
/**
 * An identity hash map of <code>KType</code> to <code>double</code>, implemented using open
 * addressing with linear probing for collision resolution.
 * 
 * <p>
 * This class implements the {@link ObjectDoubleMap} interface using
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: ObjectDoubleOpenIdentityHashMap.java") 
public class ObjectDoubleOpenIdentityHashMap<KType>
    implements ObjectDoubleMap<KType>, Cloneable
{
     ...
     */
    public ObjectDoubleOpenIdentityHashMap()
    {
     ...
     */
    public ObjectDoubleOpenIdentityHashMap(int initialCapacity)
    {
     ...
     */
    public ObjectDoubleOpenIdentityHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ObjectDoubleOpenIdentityHashMap(ObjectDoubleAssociativeContainer<KType> container)
    {
    ...
    @Override
    public int putAll(
        ObjectDoubleAssociativeContainer<? extends KType> container)
    {
        final int count = this.assigned;
        for (ObjectDoubleCursor<? extends KType> c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends ObjectDoubleCursor<? extends KType>> iterable)
    {
        final int count = this.assigned;
        for (ObjectDoubleCursor<? extends KType> c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof ObjectDoubleMap)
            {
                ...
                /*  */
                ObjectDoubleMap<KType> other = (ObjectDoubleMap<KType>) obj;
                if (other.size() == this.size())
                {
                    for (ObjectDoubleCursor<KType> c : other)
                    {
                        if (this.containsKey(c.key))
                        {
                            double v = this.get(c.key);
    ...
    private final class EntryIterator extends AbstractIterator<ObjectDoubleCursor<KType>>
    {
        ...
        {
            cursor = new ObjectDoubleCursor<KType>();
            cursor.index = -1;
        }
    ...
    {
        private final ObjectDoubleOpenIdentityHashMap<KType> owner = 
            ObjectDoubleOpenIdentityHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectDoubleOpenIdentityHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectDoubleOpenIdentityHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectDoubleOpenIdentityHashMap.this.allocated;                                                              
            final double [] values = ObjectDoubleOpenIdentityHashMap.this.values;                                                                      
            ...
            {                                                                                                                                 
                ...
                {   
                    double v = values[slot];
                                         if ((Double.doubleToLongBits(value) == Double.doubleToLongBits(v)))
                    {
                        return true;
                    }
     ...
     */
    @Override
    public ObjectDoubleOpenIdentityHashMap<KType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            ObjectDoubleOpenIdentityHashMap<KType> cloned = 
                (ObjectDoubleOpenIdentityHashMap<KType>) super.clone();
     ...
     */
    public static <KType> ObjectDoubleOpenIdentityHashMap<KType> from(KType [] keys, double [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ObjectDoubleOpenIdentityHashMap<KType> map = new ObjectDoubleOpenIdentityHashMap<KType>();
     ...
     */
    public static <KType> ObjectDoubleOpenIdentityHashMap<KType> from(ObjectDoubleAssociativeContainer<KType> container)
    {
        return new ObjectDoubleOpenIdentityHashMap<KType>(container);
    }
     ...
     * shortcut). 
     */
    public static <KType> ObjectDoubleOpenIdentityHashMap<KType> newInstance()
    {
        return new ObjectDoubleOpenIdentityHashMap<KType>();
    }
     ...
     */
    public static <KType> ObjectDoubleOpenIdentityHashMap<KType> newInstanceWithoutPerturbations()
    {
        return new ObjectDoubleOpenIdentityHashMap<KType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <KType> ObjectDoubleOpenIdentityHashMap<KType> newInstance(int initialCapacity, float loadFactor)
    {
        return new ObjectDoubleOpenIdentityHashMap<KType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <KType> ObjectDoubleOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <KType> ObjectDoubleOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
