...
/**
 * A hash map of <code>byte</code> to <code>char</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ByteCharOpenHashMap.java") 
    ...
    implements ByteCharMap, Cloneable
{
    ...
    @Override
    public int putAll(
        ByteCharAssociativeContainer container)
    {
        final int count = this.assigned;
        for (ByteCharCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends ByteCharCursor> iterable)
    {
        final int count = this.assigned;
        for (ByteCharCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            {
                /*  */
                ByteCharMap other = (ByteCharMap) obj;
     ...
     */
    private final class EntryIterator extends AbstractIterator<ByteCharCursor>
    {
        private final ByteCharCursor cursor;

        public EntryIterator()
        {
            cursor = new ByteCharCursor();
            cursor.index = -1;
        }
    ...
    {
        private final ByteCharOpenHashMap owner = 
            ByteCharOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ByteCharOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ByteCharOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ByteCharOpenHashMap.this.allocated;                                                              
            final char [] values = ByteCharOpenHashMap.this.values;                                                                      
    ...
    public ByteCharOpenHashMap clone()
    {
        ...
        {
            /*  */
            ByteCharOpenHashMap cloned = 
                (ByteCharOpenHashMap) super.clone();
    ...
    public String toString()
    {
        ...
        boolean first = true;
        for (ByteCharCursor cursor : this)
        {
    ...
    public static  ByteCharOpenHashMap from(byte [] keys, char [] values)
    {
        ...
        ByteCharOpenHashMap map = new ByteCharOpenHashMap();
    ...
    {
        return new ByteCharOpenHashMap(container);
    }
    ...
    {
        return new ByteCharOpenHashMap();
    }
    ...
    {
        return new ByteCharOpenHashMap(initialCapacity, loadFactor);
    }
