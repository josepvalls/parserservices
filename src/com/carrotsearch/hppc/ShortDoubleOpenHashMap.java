...
/**
 * A hash map of <code>short</code> to <code>double</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ShortDoubleOpenHashMap.java") 
    ...
    implements ShortDoubleMap, Cloneable
{
     ...
     */
    public ShortDoubleOpenHashMap(int initialCapacity)
    {
     ...
     */
    public ShortDoubleOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ShortDoubleOpenHashMap(ShortDoubleAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        ShortDoubleAssociativeContainer container)
    {
        final int count = this.assigned;
        for (ShortDoubleCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends ShortDoubleCursor> iterable)
    {
        final int count = this.assigned;
        for (ShortDoubleCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    public boolean putIfAbsent(short key, double value)
    {
        if (!containsKey(key))
        {
            put(key, value);
     ...
     */
    private void expandAndPut(short pendingKey, double pendingValue, int freeSlot)
    {
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ShortDoubleOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ShortDoubleOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ShortDoubleOpenHashMap.this.allocated;                                                              
            final double [] values = ShortDoubleOpenHashMap.this.values;                                                                      
    ...
    public ShortDoubleOpenHashMap clone()
    {
        ...
        {
            /*  */
            ShortDoubleOpenHashMap cloned = 
                (ShortDoubleOpenHashMap) super.clone();
    ...
    public String toString()
    {
        ...
        boolean first = true;
        for (ShortDoubleCursor cursor : this)
        {
     ...
     */
    public static  ShortDoubleOpenHashMap from(short [] keys, double [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ShortDoubleOpenHashMap map = new ShortDoubleOpenHashMap();
     ...
     */
    public static  ShortDoubleOpenHashMap from(ShortDoubleAssociativeContainer container)
    {
     ...
     */
    public static  ShortDoubleOpenHashMap newInstanceWithoutPerturbations()
    {
        return new ShortDoubleOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  ShortDoubleOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
     ...
     */
    public static  ShortDoubleOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  ShortDoubleOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
