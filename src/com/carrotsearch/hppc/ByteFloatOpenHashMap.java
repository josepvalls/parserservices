...
/**
 * A hash map of <code>byte</code> to <code>float</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ByteFloatOpenHashMap.java") 
public class ByteFloatOpenHashMap
    implements ByteFloatMap, Cloneable
{
     ...
     */
    public ByteFloatOpenHashMap(int initialCapacity)
    {
     ...
     */
    public ByteFloatOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ByteFloatOpenHashMap(ByteFloatAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        ByteFloatAssociativeContainer container)
    {
        final int count = this.assigned;
        for (ByteFloatCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends ByteFloatCursor> iterable)
    {
        final int count = this.assigned;
        for (ByteFloatCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
         ...
         public float putOrAdd(byte key, float putValue, float additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
         ...
         public float addTo(byte key, float additionValue)
    {
     ...
     */
    private final class EntryIterator extends AbstractIterator<ByteFloatCursor>
    {
        private final ByteFloatCursor cursor;

        public EntryIterator()
        {
            cursor = new ByteFloatCursor();
            cursor.index = -1;
        }
     ...
     */
    @Override
    public Iterator<ByteFloatCursor> iterator()
    {
    ...
    {
        private final ByteFloatOpenHashMap owner = 
            ByteFloatOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ByteFloatOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ByteFloatOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ByteFloatOpenHashMap.this.allocated;                                                              
            final float [] values = ByteFloatOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ByteFloatOpenHashMap clone()
    {
        try
        {
            /*  */
            ByteFloatOpenHashMap cloned = 
                (ByteFloatOpenHashMap) super.clone();
     ...
     */
    public static  ByteFloatOpenHashMap from(byte [] keys, float [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ByteFloatOpenHashMap map = new ByteFloatOpenHashMap();
     ...
     */
    public static  ByteFloatOpenHashMap from(ByteFloatAssociativeContainer container)
    {
        return new ByteFloatOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  ByteFloatOpenHashMap newInstance()
    {
        return new ByteFloatOpenHashMap();
    }
     ...
     */
    public static  ByteFloatOpenHashMap newInstanceWithoutPerturbations()
    {
        return new ByteFloatOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  ByteFloatOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new ByteFloatOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  ByteFloatOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  ByteFloatOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
