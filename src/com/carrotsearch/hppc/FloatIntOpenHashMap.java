...
/**
 * A hash map of <code>float</code> to <code>int</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: FloatIntOpenHashMap.java") 
    ...
    implements FloatIntMap, Cloneable
{
    ...
    @Override
    public int putAll(
        FloatIntAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends FloatIntCursor> iterable)
    {
        final int count = this.assigned;
        for (FloatIntCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    private final class EntryIterator extends AbstractIterator<FloatIntCursor>
    {
        private final FloatIntCursor cursor;

        public EntryIterator()
        {
            cursor = new FloatIntCursor();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = FloatIntOpenHashMap.this.allocated;                                                              
            final int [] values = FloatIntOpenHashMap.this.values;                                                                      
    ...
    public FloatIntOpenHashMap clone()
    {
        ...
        {
            /*  */
            FloatIntOpenHashMap cloned = 
                (FloatIntOpenHashMap) super.clone();
    ...
    public static  FloatIntOpenHashMap from(float [] keys, int [] values)
    {
        ...
        FloatIntOpenHashMap map = new FloatIntOpenHashMap();
