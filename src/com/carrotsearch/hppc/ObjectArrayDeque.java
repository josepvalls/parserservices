 ...
 * </table>
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ObjectArrayDeque.java") 
    ...
    extends AbstractObjectCollection<KType> implements ObjectDeque<KType>, Cloneable
{
    ...
    public ObjectArrayDeque(int initialCapacity, ArraySizingStrategy resizer)
    {
        ...
        buffer = Internals.<KType[]>newArray(initialCapacity);
    }
    ...
    {
        this.head = tail = 0;
        buffer = Internals.<KType[]>newArray(resizer.round(DEFAULT_CAPACITY));
    }
    ...
    {
        final int size = size();
        return toArray(Internals.<KType[]>newArray(size));
    }
        ...
        if (obj != null)
        {
            if (obj instanceof ObjectDeque<?>)
            {
                ...
                if (other.size() == this.size())
                {
                    ...
                    {
                        if (!((c.value) == null ? (buffer[i]) == null : (c.value).equals((buffer[i]))))
                            return false;
     ...
     */
    public static /*  */ <KType> /*  */
      ObjectArrayDeque<KType> newInstance()
    {
     ...
     */
    public static /*  */ <KType> /*  */
        ObjectArrayDeque<KType> newInstanceWithCapacity(int initialCapacity)
    {
     ...
     */
    public static /*  */ <KType> /*  */ 
        ObjectArrayDeque<KType> from(ObjectArrayDeque<KType> container)
    {
