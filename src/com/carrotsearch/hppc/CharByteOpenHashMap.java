...
/**
 * A hash map of <code>char</code> to <code>byte</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: CharByteOpenHashMap.java") 
public class CharByteOpenHashMap
    implements CharByteMap, Cloneable
{
     ...
     */
    public CharByteOpenHashMap(int initialCapacity)
    {
     ...
     */
    public CharByteOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public CharByteOpenHashMap(CharByteAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        CharByteAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends CharByteCursor> iterable)
    {
        final int count = this.assigned;
     ...
     */
         ...
         public byte putOrAdd(char key, byte putValue, byte additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
    private void expandAndPut(char pendingKey, byte pendingValue, int freeSlot)
    {
    ...
    {
        private final CharByteOpenHashMap owner = 
            CharByteOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return CharByteOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return CharByteOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = CharByteOpenHashMap.this.allocated;                                                              
            final byte [] values = CharByteOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public CharByteOpenHashMap clone()
    {
        try
        {
            /*  */
            CharByteOpenHashMap cloned = 
                (CharByteOpenHashMap) super.clone();
    ...
    public String toString()
    {
        ...
        boolean first = true;
        for (CharByteCursor cursor : this)
        {
     ...
     */
    public static  CharByteOpenHashMap from(char [] keys, byte [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        CharByteOpenHashMap map = new CharByteOpenHashMap();
     ...
     */
    public static  CharByteOpenHashMap from(CharByteAssociativeContainer container)
    {
        return new CharByteOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  CharByteOpenHashMap newInstance()
    {
        return new CharByteOpenHashMap();
    }
     ...
     */
    public static  CharByteOpenHashMap newInstanceWithoutPerturbations()
    {
        return new CharByteOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  CharByteOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new CharByteOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  CharByteOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  CharByteOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
