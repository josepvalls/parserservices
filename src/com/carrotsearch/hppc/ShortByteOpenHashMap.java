...
/**
 * A hash map of <code>short</code> to <code>byte</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ShortByteOpenHashMap.java") 
public class ShortByteOpenHashMap
    implements ShortByteMap, Cloneable
{
    /**
     ...
     */
    public ShortByteOpenHashMap(int initialCapacity)
    {
     ...
     */
    public ShortByteOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ShortByteOpenHashMap(ShortByteAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends ShortByteCursor> iterable)
    {
        final int count = this.assigned;
        for (ShortByteCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
         ...
         public byte putOrAdd(short key, byte putValue, byte additionValue)
    {
        assert assigned < allocated.length;
        ...
        extends AbstractShortCollection implements ShortLookupContainer
    {
        ...
        {
            final short [] localKeys = owner.keys;
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ShortByteOpenHashMap.this.allocated;                                                              
            final byte [] values = ShortByteOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ShortByteOpenHashMap clone()
    {
        try
        {
            /*  */
            ShortByteOpenHashMap cloned = 
                (ShortByteOpenHashMap) super.clone();
     ...
     */
    public static  ShortByteOpenHashMap from(short [] keys, byte [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ShortByteOpenHashMap map = new ShortByteOpenHashMap();
     ...
     */
    public static  ShortByteOpenHashMap from(ShortByteAssociativeContainer container)
    {
        return new ShortByteOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  ShortByteOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new ShortByteOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  ShortByteOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  ShortByteOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
