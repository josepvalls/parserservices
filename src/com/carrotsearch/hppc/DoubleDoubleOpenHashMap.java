...
/**
 * A hash map of <code>double</code> to <code>double</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: DoubleDoubleOpenHashMap.java") 
    ...
    implements DoubleDoubleMap, Cloneable
{
    ...
    @Override
    public int putAll(
        DoubleDoubleAssociativeContainer container)
    {
        final int count = this.assigned;
        for (DoubleDoubleCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends DoubleDoubleCursor> iterable)
    {
        final int count = this.assigned;
        for (DoubleDoubleCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    private final class EntryIterator extends AbstractIterator<DoubleDoubleCursor>
    {
        private final DoubleDoubleCursor cursor;

        public EntryIterator()
        {
            cursor = new DoubleDoubleCursor();
            cursor.index = -1;
        }
    ...
    {
        private final DoubleDoubleOpenHashMap owner = 
            DoubleDoubleOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return DoubleDoubleOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return DoubleDoubleOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = DoubleDoubleOpenHashMap.this.allocated;                                                              
            final double [] values = DoubleDoubleOpenHashMap.this.values;                                                                      
    ...
    public DoubleDoubleOpenHashMap clone()
    {
        ...
        {
            /*  */
            DoubleDoubleOpenHashMap cloned = 
                (DoubleDoubleOpenHashMap) super.clone();
    ...
    public static  DoubleDoubleOpenHashMap from(double [] keys, double [] values)
    {
        ...
        DoubleDoubleOpenHashMap map = new DoubleDoubleOpenHashMap();
    ...
    {
        return new DoubleDoubleOpenHashMap(container);
    }
    ...
    {
        return new DoubleDoubleOpenHashMap();
    }
    ...
    {
        return new DoubleDoubleOpenHashMap(initialCapacity, loadFactor);
    }
