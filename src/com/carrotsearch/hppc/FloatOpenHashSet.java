...
/**
 * A hash set of <code>float</code>s, implemented using using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: FloatOpenHashSet.java") 
...
`     */
    ...
    public boolean add(float e)
    {
        ...
        {
            if ((Float.floatToIntBits(e) == Float.floatToIntBits(keys[slot])))
            {
                return false;
            }
    ...
    {
        return addAll((Iterable<? extends FloatCursor>) container);
    }
     ...
     */
    private final class EntryIterator extends AbstractIterator<FloatCursor>
    {
    ...
    {
        final float [] cloned = new float [assigned];
    ...
    /**
     * Create a set from a variable number of arguments or an array of <code>float</code>.
     * The elements are copied from the argument to the internal buffer.
     */
    public static  FloatOpenHashSet from(float... elements)
    {
        final FloatOpenHashSet set = new FloatOpenHashSet(
