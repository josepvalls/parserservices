...
/**
 * A hash map of <code>float</code> to <code>VType</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: FloatObjectOpenHashMap.java") 
public class FloatObjectOpenHashMap<VType>
    implements FloatObjectMap<VType>, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        FloatObjectAssociativeContainer<? extends VType> container)
    {
        final int count = this.assigned;
        for (FloatObjectCursor<? extends VType> c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends FloatObjectCursor<? extends VType>> iterable)
    {
        final int count = this.assigned;
        for (FloatObjectCursor<? extends VType> c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    @Override
    public VType getOrDefault(float key, VType defaultValue)
    {
        final int mask = allocated.length - 1;
        int slot = rehash(key, perturbation) & mask;
        while (allocated[slot])
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof FloatObjectMap)
            {
                ...
                /*  */
                FloatObjectMap<VType> other = (FloatObjectMap<VType>) obj;
     ...
     */
    private final class EntryIterator extends AbstractIterator<FloatObjectCursor<VType>>
    {
        private final FloatObjectCursor<VType> cursor;

        public EntryIterator()
        {
            cursor = new FloatObjectCursor<VType>();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = FloatObjectOpenHashMap.this.allocated;                                                              
            final VType [] values = FloatObjectOpenHashMap.this.values;                                                                      
    ...
    public FloatObjectOpenHashMap<VType> clone()
    {
        try
        {
            ...
            @SuppressWarnings("unchecked")
            /*  */
            FloatObjectOpenHashMap<VType> cloned = 
                (FloatObjectOpenHashMap<VType>) super.clone();
     ...
     */
    public static <VType> FloatObjectOpenHashMap<VType> newInstanceWithoutPerturbations()
    {
        return new FloatObjectOpenHashMap<VType>() {
            @Override
     ...
     */
    public static <VType> FloatObjectOpenHashMap<VType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <VType> FloatObjectOpenHashMap<VType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
