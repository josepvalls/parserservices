...
/**
 * An identity hash map of <code>KType</code> to <code>float</code>, implemented using open
 * addressing with linear probing for collision resolution.
 * 
 * <p>
 * This class implements the {@link ObjectFloatMap} interface using
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: ObjectFloatOpenIdentityHashMap.java") 
public class ObjectFloatOpenIdentityHashMap<KType>
    implements ObjectFloatMap<KType>, Cloneable
{
     ...
     */
    public ObjectFloatOpenIdentityHashMap()
    {
     ...
     */
    public ObjectFloatOpenIdentityHashMap(int initialCapacity)
    {
     ...
     */
    public ObjectFloatOpenIdentityHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ObjectFloatOpenIdentityHashMap(ObjectFloatAssociativeContainer<KType> container)
    {
    ...
    @Override
    public int putAll(
        ObjectFloatAssociativeContainer<? extends KType> container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends ObjectFloatCursor<? extends KType>> iterable)
    {
        final int count = this.assigned;
     ...
     */
         ...
         public float putOrAdd(KType key, float putValue, float additionValue)
    {
        assert assigned < allocated.length;
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof ObjectFloatMap)
            {
                ...
                /*  */
                ObjectFloatMap<KType> other = (ObjectFloatMap<KType>) obj;
                if (other.size() == this.size())
                {
                    for (ObjectFloatCursor<KType> c : other)
                    {
                        if (this.containsKey(c.key))
                        {
                            float v = this.get(c.key);
    ...
    {
        private final ObjectFloatOpenIdentityHashMap<KType> owner = 
            ObjectFloatOpenIdentityHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectFloatOpenIdentityHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectFloatOpenIdentityHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectFloatOpenIdentityHashMap.this.allocated;                                                              
            final float [] values = ObjectFloatOpenIdentityHashMap.this.values;                                                                      
            ...
            {                                                                                                                                 
                ...
                {   
                    float v = values[slot];
                                         if ((Float.floatToIntBits(value) == Float.floatToIntBits(v)))
                    {
                        return true;
                    }
     ...
     */
    @Override
    public ObjectFloatOpenIdentityHashMap<KType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            ObjectFloatOpenIdentityHashMap<KType> cloned = 
                (ObjectFloatOpenIdentityHashMap<KType>) super.clone();
     ...
     */
    public static <KType> ObjectFloatOpenIdentityHashMap<KType> from(KType [] keys, float [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ObjectFloatOpenIdentityHashMap<KType> map = new ObjectFloatOpenIdentityHashMap<KType>();
     ...
     */
    public static <KType> ObjectFloatOpenIdentityHashMap<KType> from(ObjectFloatAssociativeContainer<KType> container)
    {
        return new ObjectFloatOpenIdentityHashMap<KType>(container);
    }
     ...
     * shortcut). 
     */
    public static <KType> ObjectFloatOpenIdentityHashMap<KType> newInstance()
    {
        return new ObjectFloatOpenIdentityHashMap<KType>();
    }
     ...
     */
    public static <KType> ObjectFloatOpenIdentityHashMap<KType> newInstanceWithoutPerturbations()
    {
        return new ObjectFloatOpenIdentityHashMap<KType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <KType> ObjectFloatOpenIdentityHashMap<KType> newInstance(int initialCapacity, float loadFactor)
    {
        return new ObjectFloatOpenIdentityHashMap<KType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <KType> ObjectFloatOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <KType> ObjectFloatOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
