...
/**
 * A hash map of <code>float</code> to <code>char</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: FloatCharOpenHashMap.java") 
public class FloatCharOpenHashMap
    implements FloatCharMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        FloatCharAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends FloatCharCursor> iterable)
    {
        final int count = this.assigned;
        for (FloatCharCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    private final class EntryIterator extends AbstractIterator<FloatCharCursor>
    {
        private final FloatCharCursor cursor;

        public EntryIterator()
        {
            cursor = new FloatCharCursor();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = FloatCharOpenHashMap.this.allocated;                                                              
            final char [] values = FloatCharOpenHashMap.this.values;                                                                      
    ...
    public FloatCharOpenHashMap clone()
    {
        ...
        {
            /*  */
            FloatCharOpenHashMap cloned = 
                (FloatCharOpenHashMap) super.clone();
     ...
     */
    public static  FloatCharOpenHashMap newInstanceWithoutPerturbations()
    {
        return new FloatCharOpenHashMap() {
            @Override
     ...
     */
    public static  FloatCharOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  FloatCharOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
