...
/**
 * A hash map of <code>char</code> to <code>int</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: CharIntOpenHashMap.java") 
public class CharIntOpenHashMap
    implements CharIntMap, Cloneable
{
    /**
     ...
     */
    public CharIntOpenHashMap(int initialCapacity)
    {
     ...
     */
    public CharIntOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public CharIntOpenHashMap(CharIntAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        CharIntAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends CharIntCursor> iterable)
    {
        final int count = this.assigned;
     ...
     */
         ...
         public int putOrAdd(char key, int putValue, int additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
    private void expandAndPut(char pendingKey, int pendingValue, int freeSlot)
    {
    ...
    {
        private final CharIntOpenHashMap owner = 
            CharIntOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return CharIntOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return CharIntOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = CharIntOpenHashMap.this.allocated;                                                              
            final int [] values = CharIntOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public CharIntOpenHashMap clone()
    {
        try
        {
            /*  */
            CharIntOpenHashMap cloned = 
                (CharIntOpenHashMap) super.clone();
     ...
     */
    public static  CharIntOpenHashMap from(char [] keys, int [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        CharIntOpenHashMap map = new CharIntOpenHashMap();
     ...
     */
    public static  CharIntOpenHashMap from(CharIntAssociativeContainer container)
    {
        return new CharIntOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  CharIntOpenHashMap newInstance()
    {
        return new CharIntOpenHashMap();
    }
     ...
     */
    public static  CharIntOpenHashMap newInstanceWithoutPerturbations()
    {
        return new CharIntOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  CharIntOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new CharIntOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  CharIntOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  CharIntOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
