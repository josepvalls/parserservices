...
/**
 * A hash map of <code>KType</code> to <code>long</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ObjectLongOpenHashMap.java") 
public class ObjectLongOpenHashMap<KType>
    implements ObjectLongMap<KType>, Cloneable
{
     ...
     */
    public ObjectLongOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ObjectLongOpenHashMap(ObjectLongAssociativeContainer<KType> container)
    {
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectLongOpenHashMap.this.allocated;                                                              
            final long [] values = ObjectLongOpenHashMap.this.values;                                                                      
    ...
    public ObjectLongOpenHashMap<KType> clone()
    {
        try
        {
            ...
            @SuppressWarnings("unchecked")
            /*  */
            ObjectLongOpenHashMap<KType> cloned = 
                (ObjectLongOpenHashMap<KType>) super.clone();
    ...
    public static <KType> ObjectLongOpenHashMap<KType> from(KType [] keys, long [] values)
    {
        ...
        ObjectLongOpenHashMap<KType> map = new ObjectLongOpenHashMap<KType>();
    ...
    {
        return new ObjectLongOpenHashMap<KType>(container);
    }
    ...
    {
        return new ObjectLongOpenHashMap<KType>();
    }
     ...
     * shortcut). 
     */
    public static <KType> ObjectLongOpenHashMap<KType> newInstance(int initialCapacity, float loadFactor)
    {
        return new ObjectLongOpenHashMap<KType>(initialCapacity, loadFactor);
    }
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <KType> ObjectLongOpenHashMap<KType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
