...
/**
 * A hash map of <code>byte</code> to <code>int</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ByteIntOpenHashMap.java") 
public class ByteIntOpenHashMap
    implements ByteIntMap, Cloneable
{
    /**
     ...
     */
    public ByteIntOpenHashMap(int initialCapacity)
    {
     ...
     */
    public ByteIntOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ByteIntOpenHashMap(ByteIntAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        ByteIntAssociativeContainer container)
    {
        final int count = this.assigned;
        for (ByteIntCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends ByteIntCursor> iterable)
    {
        final int count = this.assigned;
        for (ByteIntCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
         ...
         public int putOrAdd(byte key, int putValue, int additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
         ...
         public int addTo(byte key, int additionValue)
    {
     ...
     */
    private final class EntryIterator extends AbstractIterator<ByteIntCursor>
    {
        private final ByteIntCursor cursor;

        public EntryIterator()
        {
            cursor = new ByteIntCursor();
            cursor.index = -1;
        }
     ...
     */
    @Override
    public Iterator<ByteIntCursor> iterator()
    {
    ...
    {
        private final ByteIntOpenHashMap owner = 
            ByteIntOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ByteIntOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ByteIntOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ByteIntOpenHashMap.this.allocated;                                                              
            final int [] values = ByteIntOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ByteIntOpenHashMap clone()
    {
        try
        {
            /*  */
            ByteIntOpenHashMap cloned = 
                (ByteIntOpenHashMap) super.clone();
     ...
     */
    public static  ByteIntOpenHashMap from(byte [] keys, int [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ByteIntOpenHashMap map = new ByteIntOpenHashMap();
     ...
     */
    public static  ByteIntOpenHashMap from(ByteIntAssociativeContainer container)
    {
        return new ByteIntOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  ByteIntOpenHashMap newInstance()
    {
     ...
     */
    public static  ByteIntOpenHashMap newInstanceWithoutPerturbations()
    {
        return new ByteIntOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  ByteIntOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new ByteIntOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  ByteIntOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  ByteIntOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
