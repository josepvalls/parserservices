...
/**
 * A hash map of <code>long</code> to <code>VType</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: LongObjectOpenHashMap.java") 
public class LongObjectOpenHashMap<VType>
    implements LongObjectMap<VType>, Cloneable
{
    /**
     ...
     */
    public LongObjectOpenHashMap(LongObjectAssociativeContainer<VType> container)
    {
    ...
    @Override
    public int putAll(
        LongObjectAssociativeContainer<? extends VType> container)
    {
        final int count = this.assigned;
        for (LongObjectCursor<? extends VType> c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends LongObjectCursor<? extends VType>> iterable)
    {
        final int count = this.assigned;
     ...
     */
    private void expandAndPut(long pendingKey, VType pendingValue, int freeSlot)
    {
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof LongObjectMap)
            {
                ...
                /*  */
                LongObjectMap<VType> other = (LongObjectMap<VType>) obj;
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = LongObjectOpenHashMap.this.allocated;                                                              
            final VType [] values = LongObjectOpenHashMap.this.values;                                                                      
    ...
    public LongObjectOpenHashMap<VType> clone()
    {
        try
        {
            ...
            @SuppressWarnings("unchecked")
            /*  */
            LongObjectOpenHashMap<VType> cloned = 
                (LongObjectOpenHashMap<VType>) super.clone();
     ...
     */
    public static <VType> LongObjectOpenHashMap<VType> from(long [] keys, VType [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        LongObjectOpenHashMap<VType> map = new LongObjectOpenHashMap<VType>();
     ...
     */
    public static <VType> LongObjectOpenHashMap<VType> from(LongObjectAssociativeContainer<VType> container)
    {
        return new LongObjectOpenHashMap<VType>(container);
    }
    ...
    {
        return new LongObjectOpenHashMap<VType>();
    }
     ...
     * shortcut). 
     */
    public static <VType> LongObjectOpenHashMap<VType> newInstance(int initialCapacity, float loadFactor)
    {
        return new LongObjectOpenHashMap<VType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <VType> LongObjectOpenHashMap<VType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <VType> LongObjectOpenHashMap<VType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
