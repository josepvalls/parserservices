...
/**
 * A hash map of <code>float</code> to <code>float</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: FloatFloatOpenHashMap.java") 
    ...
    implements FloatFloatMap, Cloneable
{
     ...
     */
    public FloatFloatOpenHashMap(int initialCapacity)
    {
     ...
     */
    public FloatFloatOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public FloatFloatOpenHashMap(FloatFloatAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        FloatFloatAssociativeContainer container)
    {
        final int count = this.assigned;
        for (FloatFloatCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends FloatFloatCursor> iterable)
    {
        final int count = this.assigned;
        for (FloatFloatCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    public boolean putIfAbsent(float key, float value)
    {
        if (!containsKey(key))
        {
            put(key, value);
     ...
     */
    private void expandAndPut(float pendingKey, float pendingValue, int freeSlot)
    {
     ...
     */
    private final class EntryIterator extends AbstractIterator<FloatFloatCursor>
    {
        private final FloatFloatCursor cursor;

        public EntryIterator()
        {
            cursor = new FloatFloatCursor();
            cursor.index = -1;
        }
     ...
     */
    @Override
    public <T extends FloatFloatProcedure> T forEach(T procedure)
    {
        final float [] keys = this.keys;
        final float [] values = this.values;
        final boolean [] states = this.allocated;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return FloatFloatOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return FloatFloatOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = FloatFloatOpenHashMap.this.allocated;                                                              
            final float [] values = FloatFloatOpenHashMap.this.values;                                                                      
    ...
    public FloatFloatOpenHashMap clone()
    {
        ...
        {
            /*  */
            FloatFloatOpenHashMap cloned = 
                (FloatFloatOpenHashMap) super.clone();
    ...
    public String toString()
    {
        ...
        boolean first = true;
        for (FloatFloatCursor cursor : this)
        {
     ...
     */
    public static  FloatFloatOpenHashMap from(float [] keys, float [] values)
    {
     ...
     */
    public static  FloatFloatOpenHashMap from(FloatFloatAssociativeContainer container)
    {
     ...
     */
    public static  FloatFloatOpenHashMap newInstanceWithoutPerturbations()
    {
        return new FloatFloatOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  FloatFloatOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
     ...
     */
    public static  FloatFloatOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  FloatFloatOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
