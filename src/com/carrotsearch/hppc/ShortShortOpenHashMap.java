...
/**
 * A hash map of <code>short</code> to <code>short</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ShortShortOpenHashMap.java") 
    ...
    implements ShortShortMap, Cloneable
{
    ...
    @Override
    public int putAll(
        ShortShortAssociativeContainer container)
    {
        final int count = this.assigned;
        for (ShortShortCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends ShortShortCursor> iterable)
    {
        final int count = this.assigned;
        for (ShortShortCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
    ...
    {
        private final ShortShortOpenHashMap owner = 
            ShortShortOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ShortShortOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ShortShortOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ShortShortOpenHashMap.this.allocated;                                                              
            final short [] values = ShortShortOpenHashMap.this.values;                                                                      
    ...
    public ShortShortOpenHashMap clone()
    {
        ...
        {
            /*  */
            ShortShortOpenHashMap cloned = 
                (ShortShortOpenHashMap) super.clone();
    ...
    public String toString()
    {
        ...
        boolean first = true;
        for (ShortShortCursor cursor : this)
        {
    ...
    public static  ShortShortOpenHashMap from(short [] keys, short [] values)
    {
        ...
        ShortShortOpenHashMap map = new ShortShortOpenHashMap();
    ...
    {
        return new ShortShortOpenHashMap(container);
    }
    ...
    {
        return new ShortShortOpenHashMap();
    }
    ...
    {
        return new ShortShortOpenHashMap(initialCapacity, loadFactor);
    }
