...
/**
 * A hash map of <code>short</code> to <code>char</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ShortCharOpenHashMap.java") 
public class ShortCharOpenHashMap
    implements ShortCharMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        ShortCharAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends ShortCharCursor> iterable)
    {
        final int count = this.assigned;
        for (ShortCharCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    public boolean putIfAbsent(short key, char value)
    {
        if (!containsKey(key))
        {
            put(key, value);
     ...
     */
         ...
         public char putOrAdd(short key, char putValue, char additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
    private void expandAndPut(short pendingKey, char pendingValue, int freeSlot)
    {
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ShortCharOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ShortCharOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ShortCharOpenHashMap.this.allocated;                                                              
            final char [] values = ShortCharOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ShortCharOpenHashMap clone()
    {
        try
        {
            /*  */
            ShortCharOpenHashMap cloned = 
                (ShortCharOpenHashMap) super.clone();
     ...
     * shortcut). 
     */
    public static  ShortCharOpenHashMap newInstance()
    {
        return new ShortCharOpenHashMap();
    }
     ...
     */
    public static  ShortCharOpenHashMap newInstanceWithoutPerturbations()
    {
        return new ShortCharOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  ShortCharOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new ShortCharOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  ShortCharOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  ShortCharOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
