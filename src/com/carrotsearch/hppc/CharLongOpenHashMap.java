...
/**
 * A hash map of <code>char</code> to <code>long</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: CharLongOpenHashMap.java") 
public class CharLongOpenHashMap
    implements CharLongMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        CharLongAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends CharLongCursor> iterable)
    {
        final int count = this.assigned;
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = CharLongOpenHashMap.this.allocated;                                                              
            final long [] values = CharLongOpenHashMap.this.values;                                                                      
    ...
    public CharLongOpenHashMap clone()
    {
        ...
        {
            /*  */
            CharLongOpenHashMap cloned = 
                (CharLongOpenHashMap) super.clone();
