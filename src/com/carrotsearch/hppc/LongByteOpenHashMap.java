...
/**
 * A hash map of <code>long</code> to <code>byte</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: LongByteOpenHashMap.java") 
public class LongByteOpenHashMap
    implements LongByteMap, Cloneable
{
    /**
     ...
     */
    public LongByteOpenHashMap(int initialCapacity)
    {
     ...
     */
    public LongByteOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public LongByteOpenHashMap(LongByteAssociativeContainer container)
    {
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return LongByteOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return LongByteOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = LongByteOpenHashMap.this.allocated;                                                              
            final byte [] values = LongByteOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public LongByteOpenHashMap clone()
    {
        try
        {
            /*  */
            LongByteOpenHashMap cloned = 
                (LongByteOpenHashMap) super.clone();
     ...
     */
    public static  LongByteOpenHashMap from(long [] keys, byte [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        LongByteOpenHashMap map = new LongByteOpenHashMap();
     ...
     */
    public static  LongByteOpenHashMap from(LongByteAssociativeContainer container)
    {
        return new LongByteOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  LongByteOpenHashMap newInstance()
    {
        return new LongByteOpenHashMap();
    }
     ...
     */
    public static  LongByteOpenHashMap newInstanceWithoutPerturbations()
    {
        return new LongByteOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  LongByteOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new LongByteOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  LongByteOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  LongByteOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
