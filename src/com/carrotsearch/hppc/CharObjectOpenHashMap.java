...
/**
 * A hash map of <code>char</code> to <code>VType</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: CharObjectOpenHashMap.java") 
public class CharObjectOpenHashMap<VType>
    implements CharObjectMap<VType>, Cloneable
{
    /**
     ...
     */
    public CharObjectOpenHashMap(int initialCapacity)
    {
     ...
     */
    public CharObjectOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public CharObjectOpenHashMap(CharObjectAssociativeContainer<VType> container)
    {
     ...
     */
    private void expandAndPut(char pendingKey, VType pendingValue, int freeSlot)
    {
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof CharObjectMap)
            {
                ...
                /*  */
                CharObjectMap<VType> other = (CharObjectMap<VType>) obj;
    ...
    {
        private final CharObjectOpenHashMap<VType> owner = 
            CharObjectOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return CharObjectOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return CharObjectOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = CharObjectOpenHashMap.this.allocated;                                                              
            final VType [] values = CharObjectOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public CharObjectOpenHashMap<VType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            CharObjectOpenHashMap<VType> cloned = 
                (CharObjectOpenHashMap<VType>) super.clone();
     ...
     */
    public static <VType> CharObjectOpenHashMap<VType> from(char [] keys, VType [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        CharObjectOpenHashMap<VType> map = new CharObjectOpenHashMap<VType>();
     ...
     */
    public static <VType> CharObjectOpenHashMap<VType> from(CharObjectAssociativeContainer<VType> container)
    {
        return new CharObjectOpenHashMap<VType>(container);
    }
     ...
     * shortcut). 
     */
    public static <VType> CharObjectOpenHashMap<VType> newInstance()
    {
        return new CharObjectOpenHashMap<VType>();
    }
     ...
     */
    public static <VType> CharObjectOpenHashMap<VType> newInstanceWithoutPerturbations()
    {
        return new CharObjectOpenHashMap<VType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <VType> CharObjectOpenHashMap<VType> newInstance(int initialCapacity, float loadFactor)
    {
        return new CharObjectOpenHashMap<VType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <VType> CharObjectOpenHashMap<VType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <VType> CharObjectOpenHashMap<VType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
