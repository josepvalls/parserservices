...
/**
 * A hash map of <code>char</code> to <code>short</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: CharShortOpenHashMap.java") 
public class CharShortOpenHashMap
    implements CharShortMap, Cloneable
{
    /**
     ...
     */
    public CharShortOpenHashMap(int initialCapacity)
    {
     ...
     */
    public CharShortOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public CharShortOpenHashMap(CharShortAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        CharShortAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends CharShortCursor> iterable)
    {
        final int count = this.assigned;
     ...
     */
    public boolean putIfAbsent(char key, short value)
    {
        if (!containsKey(key))
        {
            put(key, value);
     ...
     */
         ...
         public short putOrAdd(char key, short putValue, short additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
    private void expandAndPut(char pendingKey, short pendingValue, int freeSlot)
    {
    ...
    {
        private final CharShortOpenHashMap owner = 
            CharShortOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return CharShortOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return CharShortOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = CharShortOpenHashMap.this.allocated;                                                              
            final short [] values = CharShortOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public CharShortOpenHashMap clone()
    {
        try
        {
            /*  */
            CharShortOpenHashMap cloned = 
                (CharShortOpenHashMap) super.clone();
    ...
    public String toString()
    {
        ...
        boolean first = true;
        for (CharShortCursor cursor : this)
        {
     ...
     */
    public static  CharShortOpenHashMap from(char [] keys, short [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        CharShortOpenHashMap map = new CharShortOpenHashMap();
     ...
     */
    public static  CharShortOpenHashMap from(CharShortAssociativeContainer container)
    {
        return new CharShortOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  CharShortOpenHashMap newInstance()
    {
        return new CharShortOpenHashMap();
    }
     ...
     */
    public static  CharShortOpenHashMap newInstanceWithoutPerturbations()
    {
        return new CharShortOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  CharShortOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new CharShortOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  CharShortOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  CharShortOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
