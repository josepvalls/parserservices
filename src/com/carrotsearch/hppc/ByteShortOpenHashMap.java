...
/**
 * A hash map of <code>byte</code> to <code>short</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ByteShortOpenHashMap.java") 
public class ByteShortOpenHashMap
    implements ByteShortMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        ByteShortAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends ByteShortCursor> iterable)
    {
        final int count = this.assigned;
        for (ByteShortCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    private final class EntryIterator extends AbstractIterator<ByteShortCursor>
    {
        private final ByteShortCursor cursor;

        public EntryIterator()
        {
            cursor = new ByteShortCursor();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ByteShortOpenHashMap.this.allocated;                                                              
            final short [] values = ByteShortOpenHashMap.this.values;                                                                      
    ...
    public ByteShortOpenHashMap clone()
    {
        ...
        {
            /*  */
            ByteShortOpenHashMap cloned = 
                (ByteShortOpenHashMap) super.clone();
