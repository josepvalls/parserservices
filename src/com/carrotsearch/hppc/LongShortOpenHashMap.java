...
/**
 * A hash map of <code>long</code> to <code>short</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: LongShortOpenHashMap.java") 
public class LongShortOpenHashMap
    implements LongShortMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        LongShortAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends LongShortCursor> iterable)
    {
        final int count = this.assigned;
        for (LongShortCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = LongShortOpenHashMap.this.allocated;                                                              
            final short [] values = LongShortOpenHashMap.this.values;                                                                      
    ...
    public LongShortOpenHashMap clone()
    {
        ...
        {
            /*  */
            LongShortOpenHashMap cloned = 
                (LongShortOpenHashMap) super.clone();
     ...
     */
    public static  LongShortOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  LongShortOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
