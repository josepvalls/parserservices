...
/**
 * A hash map of <code>int</code> to <code>char</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: IntCharOpenHashMap.java") 
public class IntCharOpenHashMap
    implements IntCharMap, Cloneable
{
    /**
     ...
     */
    public IntCharOpenHashMap(int initialCapacity)
    {
     ...
     */
    public IntCharOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public IntCharOpenHashMap(IntCharAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends IntCharCursor> iterable)
    {
        final int count = this.assigned;
     ...
     */
         ...
         public char putOrAdd(int key, char putValue, char additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
    private void expandAndPut(int pendingKey, char pendingValue, int freeSlot)
    {
    ...
    {
        private final IntCharOpenHashMap owner = 
            IntCharOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return IntCharOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return IntCharOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = IntCharOpenHashMap.this.allocated;                                                              
            final char [] values = IntCharOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public IntCharOpenHashMap clone()
    {
        try
        {
            /*  */
            IntCharOpenHashMap cloned = 
                (IntCharOpenHashMap) super.clone();
     ...
     */
    public static  IntCharOpenHashMap from(int [] keys, char [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        IntCharOpenHashMap map = new IntCharOpenHashMap();
     ...
     */
    public static  IntCharOpenHashMap from(IntCharAssociativeContainer container)
    {
        return new IntCharOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  IntCharOpenHashMap newInstance()
    {
        return new IntCharOpenHashMap();
    }
     ...
     */
    public static  IntCharOpenHashMap newInstanceWithoutPerturbations()
    {
        return new IntCharOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  IntCharOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new IntCharOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  IntCharOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  IntCharOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
