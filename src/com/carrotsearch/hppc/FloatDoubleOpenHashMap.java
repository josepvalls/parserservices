...
/**
 * A hash map of <code>float</code> to <code>double</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: FloatDoubleOpenHashMap.java") 
public class FloatDoubleOpenHashMap
    implements FloatDoubleMap, Cloneable
{
    /**
     ...
     */
    public FloatDoubleOpenHashMap(int initialCapacity)
    {
     ...
     */
    public FloatDoubleOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public FloatDoubleOpenHashMap(FloatDoubleAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        FloatDoubleAssociativeContainer container)
    {
        final int count = this.assigned;
        for (FloatDoubleCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends FloatDoubleCursor> iterable)
    {
        final int count = this.assigned;
        for (FloatDoubleCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
         ...
         public double putOrAdd(float key, double putValue, double additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
         ...
         public double addTo(float key, double additionValue)
    {
     ...
     */
    private final class EntryIterator extends AbstractIterator<FloatDoubleCursor>
    {
        private final FloatDoubleCursor cursor;

        public EntryIterator()
        {
            cursor = new FloatDoubleCursor();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return FloatDoubleOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return FloatDoubleOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = FloatDoubleOpenHashMap.this.allocated;                                                              
            final double [] values = FloatDoubleOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public FloatDoubleOpenHashMap clone()
    {
        try
        {
            /*  */
            FloatDoubleOpenHashMap cloned = 
                (FloatDoubleOpenHashMap) super.clone();
     ...
     */
    public static  FloatDoubleOpenHashMap from(float [] keys, double [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        FloatDoubleOpenHashMap map = new FloatDoubleOpenHashMap();
     ...
     */
    public static  FloatDoubleOpenHashMap from(FloatDoubleAssociativeContainer container)
    {
        return new FloatDoubleOpenHashMap(container);
    }
     ...
     */
    public static  FloatDoubleOpenHashMap newInstanceWithoutPerturbations()
    {
        return new FloatDoubleOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  FloatDoubleOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new FloatDoubleOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  FloatDoubleOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  FloatDoubleOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
