...
/**
 * A hash map of <code>double</code> to <code>float</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: DoubleFloatOpenHashMap.java") 
    ...
    implements DoubleFloatMap, Cloneable
{
    ...
    @Override
    public int putAll(
        DoubleFloatAssociativeContainer container)
    {
        final int count = this.assigned;
        for (DoubleFloatCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends DoubleFloatCursor> iterable)
    {
        final int count = this.assigned;
        for (DoubleFloatCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    private final class EntryIterator extends AbstractIterator<DoubleFloatCursor>
    {
        private final DoubleFloatCursor cursor;

        public EntryIterator()
        {
            cursor = new DoubleFloatCursor();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return DoubleFloatOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return DoubleFloatOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = DoubleFloatOpenHashMap.this.allocated;                                                              
            final float [] values = DoubleFloatOpenHashMap.this.values;                                                                      
    ...
    public DoubleFloatOpenHashMap clone()
    {
        ...
        {
            /*  */
            DoubleFloatOpenHashMap cloned = 
                (DoubleFloatOpenHashMap) super.clone();
    ...
    public static  DoubleFloatOpenHashMap from(double [] keys, float [] values)
    {
        ...
        DoubleFloatOpenHashMap map = new DoubleFloatOpenHashMap();
    ...
    {
        return new DoubleFloatOpenHashMap(container);
    }
    ...
    {
        return new DoubleFloatOpenHashMap();
    }
    ...
    {
        return new DoubleFloatOpenHashMap(initialCapacity, loadFactor);
    }
