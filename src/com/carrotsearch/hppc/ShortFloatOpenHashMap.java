...
/**
 * A hash map of <code>short</code> to <code>float</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ShortFloatOpenHashMap.java") 
    ...
    implements ShortFloatMap, Cloneable
{
    ...
    @Override
    public int putAll(
        ShortFloatAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends ShortFloatCursor> iterable)
    {
        final int count = this.assigned;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ShortFloatOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ShortFloatOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ShortFloatOpenHashMap.this.allocated;                                                              
            final float [] values = ShortFloatOpenHashMap.this.values;                                                                      
    ...
    public ShortFloatOpenHashMap clone()
    {
        ...
        {
            /*  */
            ShortFloatOpenHashMap cloned = 
                (ShortFloatOpenHashMap) super.clone();
    ...
    public static  ShortFloatOpenHashMap from(short [] keys, float [] values)
    {
        ...
        ShortFloatOpenHashMap map = new ShortFloatOpenHashMap();
    ...
    {
        return new ShortFloatOpenHashMap(container);
    }
    ...
    {
        return new ShortFloatOpenHashMap(initialCapacity, loadFactor);
    }
