...
/**
 * A hash map of <code>short</code> to <code>VType</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ShortObjectOpenHashMap.java") 
    ...
    implements ShortObjectMap<VType>, Cloneable
{
    ...
    @Override
    public int putAll(
        ShortObjectAssociativeContainer<? extends VType> container)
    {
        final int count = this.assigned;
        for (ShortObjectCursor<? extends VType> c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends ShortObjectCursor<? extends VType>> iterable)
    {
        final int count = this.assigned;
        for (ShortObjectCursor<? extends VType> c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof ShortObjectMap)
            {
                ...
                /*  */
                ShortObjectMap<VType> other = (ShortObjectMap<VType>) obj;
    ...
    private final class EntryIterator extends AbstractIterator<ShortObjectCursor<VType>>
    {
        ...
        {
            cursor = new ShortObjectCursor<VType>();
            cursor.index = -1;
        }
    ...
    {
        private final ShortObjectOpenHashMap<VType> owner = 
            ShortObjectOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ShortObjectOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ShortObjectOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ShortObjectOpenHashMap.this.allocated;                                                              
            final VType [] values = ShortObjectOpenHashMap.this.values;                                                                      
    ...
    public ShortObjectOpenHashMap<VType> clone()
    {
        try
        {
            ...
            @SuppressWarnings("unchecked")
            /*  */
            ShortObjectOpenHashMap<VType> cloned = 
                (ShortObjectOpenHashMap<VType>) super.clone();
    ...
    public static <VType> ShortObjectOpenHashMap<VType> from(short [] keys, VType [] values)
    {
        ...
        ShortObjectOpenHashMap<VType> map = new ShortObjectOpenHashMap<VType>();
    ...
    {
        return new ShortObjectOpenHashMap<VType>(container);
    }
    ...
    {
        return new ShortObjectOpenHashMap<VType>();
    }
    ...
    {
        return new ShortObjectOpenHashMap<VType>(initialCapacity, loadFactor);
    }
