...
/**
 * A hash map of <code>short</code> to <code>long</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ShortLongOpenHashMap.java") 
public class ShortLongOpenHashMap
    implements ShortLongMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        ShortLongAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends ShortLongCursor> iterable)
    {
        final int count = this.assigned;
        for (ShortLongCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
         ...
         public long putOrAdd(short key, long putValue, long additionValue)
    {
        assert assigned < allocated.length;
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            {
                /*  */
                ShortLongMap other = (ShortLongMap) obj;
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ShortLongOpenHashMap.this.allocated;                                                              
            final long [] values = ShortLongOpenHashMap.this.values;                                                                      
    ...
    public ShortLongOpenHashMap clone()
    {
        ...
        {
            /*  */
            ShortLongOpenHashMap cloned = 
                (ShortLongOpenHashMap) super.clone();
     ...
     */
    public static  ShortLongOpenHashMap newInstanceWithoutPerturbations()
    {
        return new ShortLongOpenHashMap() {
            @Override
     ...
     */
    public static  ShortLongOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  ShortLongOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
