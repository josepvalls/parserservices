...
/**
 * A hash map of <code>double</code> to <code>VType</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: DoubleObjectOpenHashMap.java") 
public class DoubleObjectOpenHashMap<VType>
    implements DoubleObjectMap<VType>, Cloneable
{
     ...
     */
    public DoubleObjectOpenHashMap()
    {
     ...
     */
    public DoubleObjectOpenHashMap(int initialCapacity)
    {
     ...
     */
    public DoubleObjectOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public DoubleObjectOpenHashMap(DoubleObjectAssociativeContainer<VType> container)
    {
    ...
    public VType put(double key, VType value)
    {
        ...
        {
            if ((Double.doubleToLongBits(key) == Double.doubleToLongBits(keys[slot])))
            {
    ...
    @Override
    public int putAll(
        DoubleObjectAssociativeContainer<? extends VType> container)
    {
        final int count = this.assigned;
        for (DoubleObjectCursor<? extends VType> c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends DoubleObjectCursor<? extends VType>> iterable)
    {
        final int count = this.assigned;
        for (DoubleObjectCursor<? extends VType> c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    @Override
    public VType getOrDefault(double key, VType defaultValue)
    {
        final int mask = allocated.length - 1;
        int slot = rehash(key, perturbation) & mask;
        while (allocated[slot])
    ...
    {
        int h = 0;
        for (DoubleObjectCursor<VType> c : this)
        {
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof DoubleObjectMap)
            {
                ...
                /*  */
                DoubleObjectMap<VType> other = (DoubleObjectMap<VType>) obj;
     ...
     */
    private final class EntryIterator extends AbstractIterator<DoubleObjectCursor<VType>>
    {
        private final DoubleObjectCursor<VType> cursor;

        public EntryIterator()
        {
            cursor = new DoubleObjectCursor<VType>();
            cursor.index = -1;
        }
     ...
     */
    @Override
    public Iterator<DoubleObjectCursor<VType>> iterator()
    {
    ...
    {
        private final DoubleObjectOpenHashMap<VType> owner = 
            DoubleObjectOpenHashMap.this;
     ...
     */
    private final class KeysIterator extends AbstractIterator<DoubleCursor>
    {
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return DoubleObjectOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return DoubleObjectOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = DoubleObjectOpenHashMap.this.allocated;                                                              
            final VType [] values = DoubleObjectOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public DoubleObjectOpenHashMap<VType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            DoubleObjectOpenHashMap<VType> cloned = 
                (DoubleObjectOpenHashMap<VType>) super.clone();
    ...
    public String toString()
    {
        ...
        boolean first = true;
        for (DoubleObjectCursor<VType> cursor : this)
        {
     ...
     */
    public static <VType> DoubleObjectOpenHashMap<VType> from(double [] keys, VType [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        DoubleObjectOpenHashMap<VType> map = new DoubleObjectOpenHashMap<VType>();
     ...
     */
    public static <VType> DoubleObjectOpenHashMap<VType> from(DoubleObjectAssociativeContainer<VType> container)
    {
        return new DoubleObjectOpenHashMap<VType>(container);
    }
     ...
     * shortcut). 
     */
    public static <VType> DoubleObjectOpenHashMap<VType> newInstance()
    {
        return new DoubleObjectOpenHashMap<VType>();
    }
     ...
     */
    public static <VType> DoubleObjectOpenHashMap<VType> newInstanceWithoutPerturbations()
    {
        return new DoubleObjectOpenHashMap<VType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <VType> DoubleObjectOpenHashMap<VType> newInstance(int initialCapacity, float loadFactor)
    {
        return new DoubleObjectOpenHashMap<VType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <VType> DoubleObjectOpenHashMap<VType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <VType> DoubleObjectOpenHashMap<VType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
