...
/**
 * A hash set of <code>double</code>s, implemented using using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: DoubleOpenHashSet.java") 
...
`     */
    ...
    public boolean add(double e)
    {
        ...
        {
            if ((Double.doubleToLongBits(e) == Double.doubleToLongBits(keys[slot])))
            {
                return false;
            }
     ...
     */
    private final class EntryIterator extends AbstractIterator<DoubleCursor>
    {
    ...
    {
        final double [] cloned = new double [assigned];
    ...
    /**
     * Create a set from a variable number of arguments or an array of <code>double</code>.
     * The elements are copied from the argument to the internal buffer.
     */
    public static  DoubleOpenHashSet from(double... elements)
    {
        final DoubleOpenHashSet set = new DoubleOpenHashSet(
