 ...
 * Collections.
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: FloatArrayDeque.java") 
public class FloatArrayDeque 
    extends AbstractFloatCollection implements FloatDeque, Cloneable
{
    /**
    ...
    {
        this.head = tail = 0;
        buffer = new float [resizer.round(DEFAULT_CAPACITY)];
    }
