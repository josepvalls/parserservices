 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: LongFloatOpenHashMap.java") 
public class LongFloatOpenHashMap
    implements LongFloatMap, Cloneable
{
    /**
     ...
     */
    public LongFloatOpenHashMap(int initialCapacity)
    {
     ...
     */
    public LongFloatOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public LongFloatOpenHashMap(LongFloatAssociativeContainer container)
    {
     ...
     */
    private void expandAndPut(long pendingKey, float pendingValue, int freeSlot)
    {
    ...
    {
        private final LongFloatOpenHashMap owner = 
            LongFloatOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return LongFloatOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return LongFloatOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = LongFloatOpenHashMap.this.allocated;                                                              
            final float [] values = LongFloatOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public LongFloatOpenHashMap clone()
    {
        try
        {
            /*  */
            LongFloatOpenHashMap cloned = 
                (LongFloatOpenHashMap) super.clone();
     ...
     */
    public static  LongFloatOpenHashMap from(long [] keys, float [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        LongFloatOpenHashMap map = new LongFloatOpenHashMap();
     ...
     */
    public static  LongFloatOpenHashMap from(LongFloatAssociativeContainer container)
    {
        return new LongFloatOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  LongFloatOpenHashMap newInstance()
    {
        return new LongFloatOpenHashMap();
    }
     ...
     */
    public static  LongFloatOpenHashMap newInstanceWithoutPerturbations()
    {
        return new LongFloatOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  LongFloatOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new LongFloatOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  LongFloatOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  LongFloatOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
