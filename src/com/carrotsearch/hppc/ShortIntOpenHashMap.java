...
/**
 * A hash map of <code>short</code> to <code>int</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ShortIntOpenHashMap.java") 
public class ShortIntOpenHashMap
    implements ShortIntMap, Cloneable
{
    /**
     ...
     */
    public ShortIntOpenHashMap(int initialCapacity)
    {
     ...
     */
    public ShortIntOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ShortIntOpenHashMap(ShortIntAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        ShortIntAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends ShortIntCursor> iterable)
    {
        final int count = this.assigned;
        for (ShortIntCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
         ...
         public int putOrAdd(short key, int putValue, int additionValue)
    {
        assert assigned < allocated.length;
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ShortIntOpenHashMap.this.allocated;                                                              
            final int [] values = ShortIntOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ShortIntOpenHashMap clone()
    {
        try
        {
            /*  */
            ShortIntOpenHashMap cloned = 
                (ShortIntOpenHashMap) super.clone();
     ...
     */
    public static  ShortIntOpenHashMap from(short [] keys, int [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ShortIntOpenHashMap map = new ShortIntOpenHashMap();
     ...
     */
    public static  ShortIntOpenHashMap from(ShortIntAssociativeContainer container)
    {
        return new ShortIntOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  ShortIntOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new ShortIntOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  ShortIntOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  ShortIntOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
