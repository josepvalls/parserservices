...
/**
 * A hash map of <code>float</code> to <code>short</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: FloatShortOpenHashMap.java") 
public class FloatShortOpenHashMap
    implements FloatShortMap, Cloneable
{
    /**
     ...
     */
    public FloatShortOpenHashMap(int initialCapacity)
    {
     ...
     */
    public FloatShortOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public FloatShortOpenHashMap(FloatShortAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        FloatShortAssociativeContainer container)
    {
        final int count = this.assigned;
        for (FloatShortCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends FloatShortCursor> iterable)
    {
        final int count = this.assigned;
        for (FloatShortCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    public boolean putIfAbsent(float key, short value)
    {
        if (!containsKey(key))
        {
            put(key, value);
     ...
     */
         ...
         public short putOrAdd(float key, short putValue, short additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
         ...
         public short addTo(float key, short additionValue)
    {
     ...
     */
    private void expandAndPut(float pendingKey, short pendingValue, int freeSlot)
    {
     ...
     */
    private final class EntryIterator extends AbstractIterator<FloatShortCursor>
    {
        private final FloatShortCursor cursor;

        public EntryIterator()
        {
            cursor = new FloatShortCursor();
            cursor.index = -1;
        }
     ...
     */
    @Override
    public Iterator<FloatShortCursor> iterator()
    {
     ...
     */
    @Override
    public <T extends FloatShortProcedure> T forEach(T procedure)
    {
        final float [] keys = this.keys;
        final short [] values = this.values;
        final boolean [] states = this.allocated;
    ...
    {
        private final FloatShortOpenHashMap owner = 
            FloatShortOpenHashMap.this;
        ...
        {
            final float [] localKeys = owner.keys;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return FloatShortOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return FloatShortOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = FloatShortOpenHashMap.this.allocated;                                                              
            final short [] values = FloatShortOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public FloatShortOpenHashMap clone()
    {
        try
        {
            /*  */
            FloatShortOpenHashMap cloned = 
                (FloatShortOpenHashMap) super.clone();
    ...
    public String toString()
    {
        ...
        boolean first = true;
        for (FloatShortCursor cursor : this)
        {
     ...
     */
    public static  FloatShortOpenHashMap from(float [] keys, short [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        FloatShortOpenHashMap map = new FloatShortOpenHashMap();
     ...
     */
    public static  FloatShortOpenHashMap from(FloatShortAssociativeContainer container)
    {
        return new FloatShortOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  FloatShortOpenHashMap newInstance()
    {
        return new FloatShortOpenHashMap();
    }
     ...
     */
    public static  FloatShortOpenHashMap newInstanceWithoutPerturbations()
    {
        return new FloatShortOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  FloatShortOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new FloatShortOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  FloatShortOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  FloatShortOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
