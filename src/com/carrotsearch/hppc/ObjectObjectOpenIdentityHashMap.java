 ...
 * 
 * <p>
 * This class implements the {@link ObjectObjectMap} interface using
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: ObjectObjectOpenIdentityHashMap.java") 
public class ObjectObjectOpenIdentityHashMap<KType, VType>
    implements ObjectObjectMap<KType, VType>, Cloneable
{
     ...
     */
    public ObjectObjectOpenIdentityHashMap()
    {
     ...
     */
    public ObjectObjectOpenIdentityHashMap(int initialCapacity)
    {
     ...
     */
    public ObjectObjectOpenIdentityHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ObjectObjectOpenIdentityHashMap(ObjectObjectAssociativeContainer<KType, VType> container)
    {
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof ObjectObjectMap)
            {
                ...
                {
                    for (ObjectObjectCursor<KType, VType> c : other)
                    {
    ...
    {
        private final ObjectObjectOpenIdentityHashMap<KType, VType> owner = 
            ObjectObjectOpenIdentityHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectObjectOpenIdentityHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectObjectOpenIdentityHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectObjectOpenIdentityHashMap.this.allocated;                                                              
            final VType [] values = ObjectObjectOpenIdentityHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ObjectObjectOpenIdentityHashMap<KType, VType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            ObjectObjectOpenIdentityHashMap<KType, VType> cloned = 
                (ObjectObjectOpenIdentityHashMap<KType, VType>) super.clone();
     ...
     */
    public static <KType, VType> ObjectObjectOpenIdentityHashMap<KType, VType> from(KType [] keys, VType [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ObjectObjectOpenIdentityHashMap<KType, VType> map = new ObjectObjectOpenIdentityHashMap<KType, VType>();
     ...
     */
    public static <KType, VType> ObjectObjectOpenIdentityHashMap<KType, VType> from(ObjectObjectAssociativeContainer<KType, VType> container)
    {
        return new ObjectObjectOpenIdentityHashMap<KType, VType>(container);
    }
     ...
     * shortcut). 
     */
    public static <KType, VType> ObjectObjectOpenIdentityHashMap<KType, VType> newInstance()
    {
        return new ObjectObjectOpenIdentityHashMap<KType, VType>();
    }
     ...
     */
    public static <KType, VType> ObjectObjectOpenIdentityHashMap<KType, VType> newInstanceWithoutPerturbations()
    {
        return new ObjectObjectOpenIdentityHashMap<KType, VType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <KType, VType> ObjectObjectOpenIdentityHashMap<KType, VType> newInstance(int initialCapacity, float loadFactor)
    {
        return new ObjectObjectOpenIdentityHashMap<KType, VType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <KType, VType> ObjectObjectOpenIdentityHashMap<KType, VType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <KType, VType> ObjectObjectOpenIdentityHashMap<KType, VType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
