 ...
 * Collections.
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: DoubleArrayDeque.java") 
        ...
        if (obj != null)
        {
            if (obj instanceof DoubleDeque)
            {
                ...
                if (other.size() == this.size())
                {
                    ...
                    {
                        if (!(Double.doubleToLongBits(c.value) == Double.doubleToLongBits(buffer[i])))
                            return false;
