...
/**
 * An identity hash map of <code>KType</code> to <code>int</code>, implemented using open
 * addressing with linear probing for collision resolution.
 * 
 * <p>
 * This class implements the {@link ObjectIntMap} interface using
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: ObjectIntOpenIdentityHashMap.java") 
public class ObjectIntOpenIdentityHashMap<KType>
    implements ObjectIntMap<KType>, Cloneable
{
     ...
     */
    public ObjectIntOpenIdentityHashMap()
    {
     ...
     */
    public ObjectIntOpenIdentityHashMap(int initialCapacity)
    {
     ...
     */
    public ObjectIntOpenIdentityHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ObjectIntOpenIdentityHashMap(ObjectIntAssociativeContainer<KType> container)
    {
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof ObjectIntMap)
            {
                ...
                {
                    for (ObjectIntCursor<KType> c : other)
                    {
                        if (this.containsKey(c.key))
                        {
                            int v = this.get(c.key);
                                                         if (((c.value) == (v)))
                            {
                                continue;
                            }
    ...
    {
        private final ObjectIntOpenIdentityHashMap<KType> owner = 
            ObjectIntOpenIdentityHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectIntOpenIdentityHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectIntOpenIdentityHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectIntOpenIdentityHashMap.this.allocated;                                                              
            final int [] values = ObjectIntOpenIdentityHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ObjectIntOpenIdentityHashMap<KType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            ObjectIntOpenIdentityHashMap<KType> cloned = 
                (ObjectIntOpenIdentityHashMap<KType>) super.clone();
     ...
     */
    public static <KType> ObjectIntOpenIdentityHashMap<KType> from(KType [] keys, int [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ObjectIntOpenIdentityHashMap<KType> map = new ObjectIntOpenIdentityHashMap<KType>();
     ...
     */
    public static <KType> ObjectIntOpenIdentityHashMap<KType> from(ObjectIntAssociativeContainer<KType> container)
    {
        return new ObjectIntOpenIdentityHashMap<KType>(container);
    }
     ...
     * shortcut). 
     */
    public static <KType> ObjectIntOpenIdentityHashMap<KType> newInstance()
    {
        return new ObjectIntOpenIdentityHashMap<KType>();
    }
     ...
     */
    public static <KType> ObjectIntOpenIdentityHashMap<KType> newInstanceWithoutPerturbations()
    {
        return new ObjectIntOpenIdentityHashMap<KType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <KType> ObjectIntOpenIdentityHashMap<KType> newInstance(int initialCapacity, float loadFactor)
    {
        return new ObjectIntOpenIdentityHashMap<KType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <KType> ObjectIntOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <KType> ObjectIntOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
