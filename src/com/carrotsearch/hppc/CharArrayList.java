 ...
 * Collections.  
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: CharArrayList.java") 
    ...
    extends AbstractCharCollection implements CharIndexedContainer, Cloneable
{
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            {
                CharIndexedContainer other = (CharIndexedContainer) obj;
                return other.size() == this.size() &&
    ...
    private boolean allIndexesEqual(
        CharIndexedContainer b1, 
        CharIndexedContainer b2, int length)
    {
        for (int i = 0; i < length; i++)
        {
            char o1 = b1.get(i); 
     ...
     */
    final static class ValueIterator extends AbstractIterator<CharCursor>
    {
    ...
    /**
     * Create a list from a variable number of arguments or an array of <code>char</code>.
