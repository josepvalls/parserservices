...
/**
 * A hash map of <code>byte</code> to <code>VType</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ByteObjectOpenHashMap.java") 
    ...
    implements ByteObjectMap<VType>, Cloneable
{
        ...
        ByteObjectAssociativeContainer<? extends VType> container)
    {
        ...
        for (ByteObjectCursor<? extends VType> c : container)
        {
            put(c.key, c.value);
        }
    ...
    {
        final int count = this.assigned;
        for (ByteObjectCursor<? extends VType> c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof ByteObjectMap)
            {
                ...
                /*  */
                ByteObjectMap<VType> other = (ByteObjectMap<VType>) obj;
     ...
     */
    private final class EntryIterator extends AbstractIterator<ByteObjectCursor<VType>>
    {
        private final ByteObjectCursor<VType> cursor;

        public EntryIterator()
        {
            cursor = new ByteObjectCursor<VType>();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ByteObjectOpenHashMap.this.allocated;                                                              
            final VType [] values = ByteObjectOpenHashMap.this.values;                                                                      
    ...
    public ByteObjectOpenHashMap<VType> clone()
    {
        try
        {
            ...
            @SuppressWarnings("unchecked")
            /*  */
            ByteObjectOpenHashMap<VType> cloned = 
                (ByteObjectOpenHashMap<VType>) super.clone();
    ...
    {
        return new ByteObjectOpenHashMap<VType>();
    }
    ...
    {
        return new ByteObjectOpenHashMap<VType>(initialCapacity, loadFactor);
    }
