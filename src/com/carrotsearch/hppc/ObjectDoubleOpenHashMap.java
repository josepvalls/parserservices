...
/**
 * A hash map of <code>KType</code> to <code>double</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ObjectDoubleOpenHashMap.java") 
    ...
    implements ObjectDoubleMap<KType>, Cloneable
{
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectDoubleOpenHashMap.this.allocated;                                                              
            final double [] values = ObjectDoubleOpenHashMap.this.values;                                                                      
    ...
    public ObjectDoubleOpenHashMap<KType> clone()
    {
        try
        {
            ...
            @SuppressWarnings("unchecked")
            /*  */
            ObjectDoubleOpenHashMap<KType> cloned = 
                (ObjectDoubleOpenHashMap<KType>) super.clone();
