...
/**
 * A hash map of <code>KType</code> to <code>short</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ObjectShortOpenHashMap.java") 
    ...
    implements ObjectShortMap<KType>, Cloneable
{
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectShortOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectShortOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectShortOpenHashMap.this.allocated;                                                              
            final short [] values = ObjectShortOpenHashMap.this.values;                                                                      
    ...
    public ObjectShortOpenHashMap<KType> clone()
    {
        try
        {
            ...
            @SuppressWarnings("unchecked")
            /*  */
            ObjectShortOpenHashMap<KType> cloned = 
                (ObjectShortOpenHashMap<KType>) super.clone();
    ...
    {
        return new ObjectShortOpenHashMap<KType>();
    }
    ...
    {
        return new ObjectShortOpenHashMap<KType>(initialCapacity, loadFactor);
    }
