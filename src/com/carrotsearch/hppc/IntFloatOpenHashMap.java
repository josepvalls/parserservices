...
/**
 * A hash map of <code>int</code> to <code>float</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: IntFloatOpenHashMap.java") 
public class IntFloatOpenHashMap
    implements IntFloatMap, Cloneable
{
    /**
     ...
     */
    public IntFloatOpenHashMap(int initialCapacity)
    {
     ...
     */
    public IntFloatOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public IntFloatOpenHashMap(IntFloatAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        IntFloatAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends IntFloatCursor> iterable)
    {
        final int count = this.assigned;
     ...
     */
         ...
         public float putOrAdd(int key, float putValue, float additionValue)
    {
        assert assigned < allocated.length;
    ...
    {
        private final IntFloatOpenHashMap owner = 
            IntFloatOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return IntFloatOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return IntFloatOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = IntFloatOpenHashMap.this.allocated;                                                              
            final float [] values = IntFloatOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public IntFloatOpenHashMap clone()
    {
        try
        {
            /*  */
            IntFloatOpenHashMap cloned = 
                (IntFloatOpenHashMap) super.clone();
     ...
     */
    public static  IntFloatOpenHashMap from(int [] keys, float [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        IntFloatOpenHashMap map = new IntFloatOpenHashMap();
     ...
     */
    public static  IntFloatOpenHashMap from(IntFloatAssociativeContainer container)
    {
        return new IntFloatOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  IntFloatOpenHashMap newInstance()
    {
        return new IntFloatOpenHashMap();
    }
     ...
     */
    public static  IntFloatOpenHashMap newInstanceWithoutPerturbations()
    {
        return new IntFloatOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  IntFloatOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new IntFloatOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  IntFloatOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  IntFloatOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
