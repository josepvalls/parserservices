...
public class IntObjectOpenHashMap<VType>
    implements IntObjectMap<VType>, Cloneable
{
    /**
     ...
     */
    public IntObjectOpenHashMap(int initialCapacity)
    {
     ...
     */
    public IntObjectOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public IntObjectOpenHashMap(IntObjectAssociativeContainer<VType> container)
    {
    ...
    {
        private final IntObjectOpenHashMap<VType> owner = 
            IntObjectOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return IntObjectOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return IntObjectOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = IntObjectOpenHashMap.this.allocated;                                                              
            final VType [] values = IntObjectOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public IntObjectOpenHashMap<VType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            IntObjectOpenHashMap<VType> cloned = 
                (IntObjectOpenHashMap<VType>) super.clone();
     ...
     */
    public static <VType> IntObjectOpenHashMap<VType> from(int [] keys, VType [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        IntObjectOpenHashMap<VType> map = new IntObjectOpenHashMap<VType>();
     ...
     */
    public static <VType> IntObjectOpenHashMap<VType> from(IntObjectAssociativeContainer<VType> container)
    {
        return new IntObjectOpenHashMap<VType>(container);
    }
     ...
     * shortcut). 
     */
    public static <VType> IntObjectOpenHashMap<VType> newInstance()
    {
        return new IntObjectOpenHashMap<VType>();
    }
     ...
     */
    public static <VType> IntObjectOpenHashMap<VType> newInstanceWithoutPerturbations()
    {
        return new IntObjectOpenHashMap<VType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <VType> IntObjectOpenHashMap<VType> newInstance(int initialCapacity, float loadFactor)
    {
        return new IntObjectOpenHashMap<VType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <VType> IntObjectOpenHashMap<VType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <VType> IntObjectOpenHashMap<VType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
