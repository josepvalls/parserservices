...
/**
 * A hash map of <code>double</code> to <code>char</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: DoubleCharOpenHashMap.java") 
    ...
    implements DoubleCharMap, Cloneable
{
    ...
    @Override
    public int putAll(
        Iterable<? extends DoubleCharCursor> iterable)
    {
        final int count = this.assigned;
     ...
     */
         ...
         public char putOrAdd(double key, char putValue, char additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
         ...
         public char addTo(double key, char additionValue)
    {
     ...
     */
    private final class EntryIterator extends AbstractIterator<DoubleCharCursor>
    {
     ...
     */
    public static  DoubleCharOpenHashMap newInstanceWithoutPerturbations()
    {
        return new DoubleCharOpenHashMap() {
            @Override
     ...
     */
    public static  DoubleCharOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  DoubleCharOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
