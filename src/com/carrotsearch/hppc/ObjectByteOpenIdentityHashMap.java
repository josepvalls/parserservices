...
/**
 * An identity hash map of <code>KType</code> to <code>byte</code>, implemented using open
 * addressing with linear probing for collision resolution.
 * 
 * <p>
 * This class implements the {@link ObjectByteMap} interface using
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: ObjectByteOpenIdentityHashMap.java") 
public class ObjectByteOpenIdentityHashMap<KType>
    implements ObjectByteMap<KType>, Cloneable
{
    /**
     ...
     */
    public ObjectByteOpenIdentityHashMap()
    {
     ...
     */
    public ObjectByteOpenIdentityHashMap(int initialCapacity)
    {
     ...
     */
    public ObjectByteOpenIdentityHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ObjectByteOpenIdentityHashMap(ObjectByteAssociativeContainer<KType> container)
    {
    ...
    public byte put(KType key, byte value)
    {
        ...
        while (allocated[slot])
        {
            if (key == keys[slot])
            {
                final byte oldValue = values[slot];
                values[slot] = value;
                return oldValue;
            }
    ...
    @Override
    public int putAll(
        ObjectByteAssociativeContainer<? extends KType> container)
    {
        final int count = this.assigned;
        for (ObjectByteCursor<? extends KType> c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends ObjectByteCursor<? extends KType>> iterable)
    {
        final int count = this.assigned;
        for (ObjectByteCursor<? extends KType> c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
         ...
         public byte putOrAdd(KType key, byte putValue, byte additionValue)
    {
        assert assigned < allocated.length;
        ...
        while (allocated[slot])
        {
            if (key == keys[slot])
            {
                return values[slot] = (byte) (values[slot] + additionValue);
            }
    ...
    public byte lset(byte key)
    {
        ...
        final byte previous = values[lastSlot];
        values[lastSlot] = key;
        return previous;
    }
    ...
    public boolean equals(Object obj)
    {
        if (obj != null)
        {
            ...
            if (obj instanceof ObjectByteMap)
            {
                ...
                /*  */
                ObjectByteMap<KType> other = (ObjectByteMap<KType>) obj;
                if (other.size() == this.size())
                {
                    for (ObjectByteCursor<KType> c : other)
                    {
                        if (this.containsKey(c.key))
                        {
                            byte v = this.get(c.key);
                                                         if (((c.value) == (v)))
                            {
                                continue;
                            }
    ...
    private final class EntryIterator extends AbstractIterator<ObjectByteCursor<KType>>
    {
        ...
        {
            cursor = new ObjectByteCursor<KType>();
            cursor.index = -1;
        }
    ...
    {
        private final ObjectByteOpenIdentityHashMap<KType> owner = 
            ObjectByteOpenIdentityHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectByteOpenIdentityHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectByteOpenIdentityHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectByteOpenIdentityHashMap.this.allocated;                                                              
            final byte [] values = ObjectByteOpenIdentityHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ObjectByteOpenIdentityHashMap<KType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            ObjectByteOpenIdentityHashMap<KType> cloned = 
                (ObjectByteOpenIdentityHashMap<KType>) super.clone();
     ...
     */
    public static <KType> ObjectByteOpenIdentityHashMap<KType> from(KType [] keys, byte [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ObjectByteOpenIdentityHashMap<KType> map = new ObjectByteOpenIdentityHashMap<KType>();
     ...
     */
    public static <KType> ObjectByteOpenIdentityHashMap<KType> from(ObjectByteAssociativeContainer<KType> container)
    {
        return new ObjectByteOpenIdentityHashMap<KType>(container);
    }
     ...
     * shortcut). 
     */
    public static <KType> ObjectByteOpenIdentityHashMap<KType> newInstance()
    {
        return new ObjectByteOpenIdentityHashMap<KType>();
    }
     ...
     */
    public static <KType> ObjectByteOpenIdentityHashMap<KType> newInstanceWithoutPerturbations()
    {
        return new ObjectByteOpenIdentityHashMap<KType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <KType> ObjectByteOpenIdentityHashMap<KType> newInstance(int initialCapacity, float loadFactor)
    {
        return new ObjectByteOpenIdentityHashMap<KType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <KType> ObjectByteOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <KType> ObjectByteOpenIdentityHashMap<KType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
