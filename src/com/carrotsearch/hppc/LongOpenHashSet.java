 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: LongOpenHashSet.java") 
...
`     */
     ...
     */
    private final class EntryIterator extends AbstractIterator<LongCursor>
    {
    ...
    {
        final long [] cloned = new long [assigned];
    ...
    public LongOpenHashSet clone()
    {
        ...
        {
            /*  */
            LongOpenHashSet cloned = (LongOpenHashSet) super.clone();
    ...
    /**
     * Create a set from a variable number of arguments or an array of <code>long</code>.
    ...
    {
        return new LongOpenHashSet(container);
    }
