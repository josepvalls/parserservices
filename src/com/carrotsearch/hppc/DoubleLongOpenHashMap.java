...
/**
 * A hash map of <code>double</code> to <code>long</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: DoubleLongOpenHashMap.java") 
public class DoubleLongOpenHashMap
    implements DoubleLongMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        DoubleLongAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends DoubleLongCursor> iterable)
    {
        final int count = this.assigned;
        for (DoubleLongCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
         ...
         public long putOrAdd(double key, long putValue, long additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
         ...
         public long addTo(double key, long additionValue)
    {
     ...
     */
    private final class EntryIterator extends AbstractIterator<DoubleLongCursor>
    {
        private final DoubleLongCursor cursor;

        public EntryIterator()
        {
            cursor = new DoubleLongCursor();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = DoubleLongOpenHashMap.this.allocated;                                                              
            final long [] values = DoubleLongOpenHashMap.this.values;                                                                      
    ...
    public DoubleLongOpenHashMap clone()
    {
        ...
        {
            /*  */
            DoubleLongOpenHashMap cloned = 
                (DoubleLongOpenHashMap) super.clone();
     ...
     */
    public static  DoubleLongOpenHashMap newInstanceWithoutPerturbations()
    {
        return new DoubleLongOpenHashMap() {
            @Override
     ...
     */
    public static  DoubleLongOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  DoubleLongOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
