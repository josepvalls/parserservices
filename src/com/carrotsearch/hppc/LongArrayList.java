...
/**
 * An array-backed list of longs. A single array is used to store and manipulate
 ...
 * Collections.  
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: LongArrayList.java") 
public class LongArrayList
    extends AbstractLongCollection implements LongIndexedContainer, Cloneable
{
    /**
    ...
    public void clear()
    {
        Arrays.fill(buffer, 0, elementsCount, ((long) 0)); 
    ...
    private boolean allIndexesEqual(
        LongIndexedContainer b1, 
        LongIndexedContainer b2, int length)
    {
        for (int i = 0; i < length; i++)
        {
            long o1 = b1.get(i); 
     ...
     */
    final static class ValueIterator extends AbstractIterator<LongCursor>
    {
     ...
     */
    public static /*  */
      LongArrayList newInstanceWithCapacity(int initialCapacity)
    {
        return new LongArrayList(initialCapacity);
    }

    /**
     * Create a list from a variable number of arguments or an array of <code>long</code>.
     ...
     */
    public static /*  */ 
    LongArrayList from(LongContainer container)
    {
