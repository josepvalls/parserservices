...
/**
 * A hash map of <code>char</code> to <code>char</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: CharCharOpenHashMap.java") 
    ...
    implements CharCharMap, Cloneable
{
    ...
    @Override
    public int putAll(
        CharCharAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends CharCharCursor> iterable)
    {
        final int count = this.assigned;
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = CharCharOpenHashMap.this.allocated;                                                              
            final char [] values = CharCharOpenHashMap.this.values;                                                                      
    ...
    public CharCharOpenHashMap clone()
    {
        ...
        {
            /*  */
            CharCharOpenHashMap cloned = 
                (CharCharOpenHashMap) super.clone();
