...
/**
 * A hash map of <code>float</code> to <code>long</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: FloatLongOpenHashMap.java") 
public class FloatLongOpenHashMap
    implements FloatLongMap, Cloneable
{
    /**
     ...
     */
    public FloatLongOpenHashMap(int initialCapacity)
    {
     ...
     */
    public FloatLongOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public FloatLongOpenHashMap(FloatLongAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        FloatLongAssociativeContainer container)
    {
        final int count = this.assigned;
        for (FloatLongCursor c : container)
        {
            put(c.key, c.value);
        }
    ...
    @Override
    public int putAll(
        Iterable<? extends FloatLongCursor> iterable)
    {
        final int count = this.assigned;
        for (FloatLongCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
    public boolean putIfAbsent(float key, long value)
    {
        if (!containsKey(key))
        {
            put(key, value);
     ...
     */
         ...
         public long putOrAdd(float key, long putValue, long additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
         ...
         public long addTo(float key, long additionValue)
    {
     ...
     */
    private void expandAndPut(float pendingKey, long pendingValue, int freeSlot)
    {
     ...
     */
    private final class EntryIterator extends AbstractIterator<FloatLongCursor>
    {
        private final FloatLongCursor cursor;

        public EntryIterator()
        {
            cursor = new FloatLongCursor();
            cursor.index = -1;
        }

        @Override
        protected FloatLongCursor fetch()
        {
     ...
     */
    @Override
    public Iterator<FloatLongCursor> iterator()
    {
     ...
     */
    @Override
    public <T extends FloatLongProcedure> T forEach(T procedure)
    {
        final float [] keys = this.keys;
        final long [] values = this.values;
        final boolean [] states = this.allocated;
    ...
    {
        private final FloatLongOpenHashMap owner = 
            FloatLongOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return FloatLongOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return FloatLongOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = FloatLongOpenHashMap.this.allocated;                                                              
            final long [] values = FloatLongOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public FloatLongOpenHashMap clone()
    {
        try
        {
            /*  */
            FloatLongOpenHashMap cloned = 
                (FloatLongOpenHashMap) super.clone();
    ...
    public String toString()
    {
        ...
        boolean first = true;
        for (FloatLongCursor cursor : this)
        {
     ...
     */
    public static  FloatLongOpenHashMap from(float [] keys, long [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        FloatLongOpenHashMap map = new FloatLongOpenHashMap();
     ...
     */
    public static  FloatLongOpenHashMap from(FloatLongAssociativeContainer container)
    {
        return new FloatLongOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  FloatLongOpenHashMap newInstance()
    {
        return new FloatLongOpenHashMap();
    }
     ...
     */
    public static  FloatLongOpenHashMap newInstanceWithoutPerturbations()
    {
        return new FloatLongOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  FloatLongOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new FloatLongOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  FloatLongOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  FloatLongOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
