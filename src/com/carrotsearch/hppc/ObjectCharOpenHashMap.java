...
/**
 * A hash map of <code>KType</code> to <code>char</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ObjectCharOpenHashMap.java") 
    ...
    implements ObjectCharMap<KType>, Cloneable
{
    ...
    {
        private final ObjectCharOpenHashMap<KType> owner = 
            ObjectCharOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectCharOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectCharOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectCharOpenHashMap.this.allocated;                                                              
            final char [] values = ObjectCharOpenHashMap.this.values;                                                                      
    ...
    public ObjectCharOpenHashMap<KType> clone()
    {
        try
        {
            ...
            @SuppressWarnings("unchecked")
            /*  */
            ObjectCharOpenHashMap<KType> cloned = 
                (ObjectCharOpenHashMap<KType>) super.clone();
    ...
    public static <KType> ObjectCharOpenHashMap<KType> from(KType [] keys, char [] values)
    {
        ...
        ObjectCharOpenHashMap<KType> map = new ObjectCharOpenHashMap<KType>();
    ...
    {
        return new ObjectCharOpenHashMap<KType>(container);
    }
    ...
    {
        return new ObjectCharOpenHashMap<KType>();
    }
    ...
    {
        return new ObjectCharOpenHashMap<KType>(initialCapacity, loadFactor);
    }
