...
/**
 * A hash map of <code>long</code> to <code>double</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:30+0200", value = "HPPC generated from: LongDoubleOpenHashMap.java") 
public class LongDoubleOpenHashMap
    implements LongDoubleMap, Cloneable
{
    /**
     ...
     */
    public LongDoubleOpenHashMap(int initialCapacity)
    {
     ...
     */
    public LongDoubleOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public LongDoubleOpenHashMap(LongDoubleAssociativeContainer container)
    {
     ...
     */
         ...
         public double putOrAdd(long key, double putValue, double additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
    private void expandAndPut(long pendingKey, double pendingValue, int freeSlot)
    {
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = LongDoubleOpenHashMap.this.allocated;                                                              
            final double [] values = LongDoubleOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public LongDoubleOpenHashMap clone()
    {
        try
        {
            /*  */
            LongDoubleOpenHashMap cloned = 
                (LongDoubleOpenHashMap) super.clone();
     ...
     */
    public static  LongDoubleOpenHashMap from(long [] keys, double [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        LongDoubleOpenHashMap map = new LongDoubleOpenHashMap();
     ...
     */
    public static  LongDoubleOpenHashMap from(LongDoubleAssociativeContainer container)
    {
        return new LongDoubleOpenHashMap(container);
    }
     ...
     * shortcut). 
     */
    public static  LongDoubleOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new LongDoubleOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  LongDoubleOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  LongDoubleOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
