...
/**
 * A hash map of <code>int</code> to <code>byte</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: IntByteOpenHashMap.java") 
public class IntByteOpenHashMap
    implements IntByteMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        IntByteAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends IntByteCursor> iterable)
    {
        final int count = this.assigned;
        for (IntByteCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
         ...
         public byte putOrAdd(int key, byte putValue, byte additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
    private void expandAndPut(int pendingKey, byte pendingValue, int freeSlot)
    {
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = IntByteOpenHashMap.this.allocated;                                                              
            final byte [] values = IntByteOpenHashMap.this.values;                                                                      
    ...
    public IntByteOpenHashMap clone()
    {
        ...
        {
            /*  */
            IntByteOpenHashMap cloned = 
                (IntByteOpenHashMap) super.clone();
     ...
     */
    public static  IntByteOpenHashMap newInstanceWithoutPerturbations()
    {
        return new IntByteOpenHashMap() {
            @Override
     ...
     */
    public static  IntByteOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  IntByteOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
