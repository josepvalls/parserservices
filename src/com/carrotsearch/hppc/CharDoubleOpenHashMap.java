...
/**
 * A hash map of <code>char</code> to <code>double</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: CharDoubleOpenHashMap.java") 
public class CharDoubleOpenHashMap
    implements CharDoubleMap, Cloneable
{
    /**
    ...
    @Override
    public int putAll(
        CharDoubleAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends CharDoubleCursor> iterable)
    {
        final int count = this.assigned;
     ...
     */
         ...
         public double putOrAdd(char key, double putValue, double additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
    private final class EntryIterator extends AbstractIterator<CharDoubleCursor>
    {
        private final CharDoubleCursor cursor;

        public EntryIterator()
        {
            cursor = new CharDoubleCursor();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = CharDoubleOpenHashMap.this.allocated;                                                              
            final double [] values = CharDoubleOpenHashMap.this.values;                                                                      
    ...
    public CharDoubleOpenHashMap clone()
    {
        ...
        {
            /*  */
            CharDoubleOpenHashMap cloned = 
                (CharDoubleOpenHashMap) super.clone();
     ...
     */
    public static  CharDoubleOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  CharDoubleOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
