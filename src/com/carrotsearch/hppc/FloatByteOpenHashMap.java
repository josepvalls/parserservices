...
/**
 * A hash map of <code>float</code> to <code>byte</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: FloatByteOpenHashMap.java") 
public class FloatByteOpenHashMap
    implements FloatByteMap, Cloneable
{
    /**
     ...
     */
    public FloatByteOpenHashMap(int initialCapacity)
    {
     ...
     */
    public FloatByteOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public FloatByteOpenHashMap(FloatByteAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        FloatByteAssociativeContainer container)
    {
    ...
    @Override
    public int putAll(
        Iterable<? extends FloatByteCursor> iterable)
    {
        final int count = this.assigned;
        for (FloatByteCursor c : iterable)
        {
            put(c.key, c.value);
        }
        return this.assigned - count;
     ...
     */
         ...
         public byte putOrAdd(float key, byte putValue, byte additionValue)
    {
        assert assigned < allocated.length;
     ...
     */
         ...
         public byte addTo(float key, byte additionValue)
    {
     ...
     */
    private void expandAndPut(float pendingKey, byte pendingValue, int freeSlot)
    {
     ...
     */
    private final class EntryIterator extends AbstractIterator<FloatByteCursor>
    {
        private final FloatByteCursor cursor;

        public EntryIterator()
        {
            cursor = new FloatByteCursor();
            cursor.index = -1;
        }
    ...
    {                                                                                                                                         
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = FloatByteOpenHashMap.this.allocated;                                                              
            final byte [] values = FloatByteOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public FloatByteOpenHashMap clone()
    {
        try
        {
            /*  */
            FloatByteOpenHashMap cloned = 
                (FloatByteOpenHashMap) super.clone();
     ...
     */
    public static  FloatByteOpenHashMap from(float [] keys, byte [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        FloatByteOpenHashMap map = new FloatByteOpenHashMap();
     ...
     */
    public static  FloatByteOpenHashMap from(FloatByteAssociativeContainer container)
    {
        return new FloatByteOpenHashMap(container);
    }
     ...
     */
    public static  FloatByteOpenHashMap newInstanceWithoutPerturbations()
    {
        return new FloatByteOpenHashMap() {
            @Override
     ...
     * shortcut). 
     */
    public static  FloatByteOpenHashMap newInstance(int initialCapacity, float loadFactor)
    {
        return new FloatByteOpenHashMap(initialCapacity, loadFactor);
    }
     ...
     */
    public static  FloatByteOpenHashMap newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static  FloatByteOpenHashMap newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
