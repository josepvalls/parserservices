...
/**
 * A hash map of <code>KType</code> to <code>float</code>, implemented using open
 ...
 */
 @javax.annotation.Generated(date = "2014-09-08T10:42:29+0200", value = "HPPC generated from: ObjectFloatOpenHashMap.java") 
public class ObjectFloatOpenHashMap<KType>
    implements ObjectFloatMap<KType>, Cloneable
{
     ...
     */
    public ObjectFloatOpenHashMap(int initialCapacity)
    {
     ...
     */
    public ObjectFloatOpenHashMap(int initialCapacity, float loadFactor)
    {
     ...
     */
    public ObjectFloatOpenHashMap(ObjectFloatAssociativeContainer<KType> container)
    {
    ...
    {
        private final ObjectFloatOpenHashMap<KType> owner = 
            ObjectFloatOpenHashMap.this;
    ...
    {                                                                                                                                         
        ...
        public int size()                                                                                                                     
        {                                                                                                                                     
            return ObjectFloatOpenHashMap.this.size();                                                                                       
        }                                                                                                                                     
                                                                                                                                              
        @Override                                                                                                                             
        public boolean isEmpty()                                                                                                              
        {                                                                                                                                     
            return ObjectFloatOpenHashMap.this.isEmpty();                                                                                    
        }                                                                                                                                     
        ...
        {                                                                                                                                     
            ...
            final boolean [] allocated = ObjectFloatOpenHashMap.this.allocated;                                                              
            final float [] values = ObjectFloatOpenHashMap.this.values;                                                                      
     ...
     */
    @Override
    public ObjectFloatOpenHashMap<KType> clone()
    {
        try
        {
            /*  */
            @SuppressWarnings("unchecked")
            /*  */
            ObjectFloatOpenHashMap<KType> cloned = 
                (ObjectFloatOpenHashMap<KType>) super.clone();
     ...
     */
    public static <KType> ObjectFloatOpenHashMap<KType> from(KType [] keys, float [] values)
    {
        if (keys.length != values.length) 
            throw new IllegalArgumentException("Arrays of keys and values must have an identical length."); 

        ObjectFloatOpenHashMap<KType> map = new ObjectFloatOpenHashMap<KType>();
     ...
     */
    public static <KType> ObjectFloatOpenHashMap<KType> from(ObjectFloatAssociativeContainer<KType> container)
    {
        return new ObjectFloatOpenHashMap<KType>(container);
    }
     ...
     * shortcut). 
     */
    public static <KType> ObjectFloatOpenHashMap<KType> newInstance()
    {
        return new ObjectFloatOpenHashMap<KType>();
    }
     ...
     */
    public static <KType> ObjectFloatOpenHashMap<KType> newInstanceWithoutPerturbations()
    {
        return new ObjectFloatOpenHashMap<KType>() {
            @Override
     ...
     * shortcut). 
     */
    public static <KType> ObjectFloatOpenHashMap<KType> newInstance(int initialCapacity, float loadFactor)
    {
        return new ObjectFloatOpenHashMap<KType>(initialCapacity, loadFactor);
    }
     ...
     */
    public static <KType> ObjectFloatOpenHashMap<KType> newInstanceWithExpectedSize(int expectedSize)
    {
     ...
     * <code>expectedSize</code> elements without having to resize.
     */
    public static <KType> ObjectFloatOpenHashMap<KType> newInstanceWithExpectedSize(int expectedSize, float loadFactor)
    {
