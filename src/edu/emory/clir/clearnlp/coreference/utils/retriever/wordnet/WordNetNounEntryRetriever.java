...
public class WordNetNounEntryRetriever implements WordNetFeatureType {
	...
	public Set<String> getSynonyms(String wordForm){
		...
		return db_serialized.get(Synonym).getOrDefault(wordForm, new HashSet<String>());
	}
	...
	public Set<String> getAntonyms(String wordForm){
		...
		return db_serialized.get(Antonym).getOrDefault(wordForm, new HashSet<String>());
	}
	...
	public Set<String> getHypernyms(String wordForm){
		...
		return db_serialized.get(Hypernym).getOrDefault(wordForm, new HashSet<String>());
	}
