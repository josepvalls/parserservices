...
class MeChart : public Bchart
{
 public:
  ...
  AnsTreeStr& findMapParse();
  AnsTreeStr& bestParse(Item* itm, FullHist* h,AnsTree* cat,AnsTree* gcat,int cdir);
  AnsTreeStr& bestParseGivenHead(int posInt, const Wrd& wd, Item* itm,
				 FullHist* h,ItmGHeadInfo& ighInfo,
				 AnsTree* cat,AnsTree* gcat);
  void  fillInHeads();
  ...
  AnsTreeStr& recordedBP(Item* itm, FullHist* h);
  AnsTreeStr& recordedBPGH(Item* itm, AnsTreeMap& atm, FullHist* h);
